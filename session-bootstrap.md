...
| 항목 | 값 |
|------|-----|
| 마지막 종목분석 | **009150 삼성전기 v2 재분석 - 2026-04-23**, Buy **72.4** (v1 74.75 → **-2.35p**, Buy 유지 Strong Buy 하단 경계 -7.6점 하향, 성장주, 시총 **58.5조원**, AI 서버 FC-BGA 수요 **+60% YoY** 확정 + 하이퍼 CapEx **$6,800억 (+127%)** 확정 + 중국 관세 125% 반사이익으로 Moat Wide 전환, 한국 관세 15% 확정 (2026-04-21) 순영향 중립 (-675억 관세 손실 vs +800억 중국 배제 반사이익 = +125억), PER Fwd 2026E 33.8x (v1 26.8x 재레이팅), 컨센 목표가 674K → **720K +6.8%** 이미 초과 -7%), 목표 **Base 810,000원 +4.7%** v1 +7.8% 축소, 손절 685,714원 (2×ATR, -11.4%), R:R Base **0.41 Poor** (720K 조정 진입 시 2.63 Good), 기대값 현재가 +4.8% / 720K 조정 진입 +12.7% — **핵심 변화**: 8일간 +26.1% 급등 (614K→774K) + RSI 74 과매수 2주 지속 + 컨센 720K 이미 초과 / **펀더멘털 +0.5점** (FC-BGA Wide 전환 + 중국 배제) vs **가격 -2.85점** (재레이팅 + 과열 + Bear 확률 10→20%) / 1Q26 실적(4/29) -5%+ 미스 시 -15~20% 갭다운 리스크 / **사용자 한국 내수 0% 해소 후보 3% 편입 권고** (VOO 91.5%→88.5% 축소), **720,000원 이하 조정 시까지 진입 대기** (추격매수 절대 금지) / AI 인프라 블록 NVDA 6%+AVGO 5%+009150 3% = 14% 동조화 주의 |
