...
# Research Meta — Biotech (바이오)

> 현 capex 19종 직접 노출 없음. 그러나 모델 포트폴리오·내포트폴리오 추천 시 GLP-1·항암제 파이프라인 후보 평가 필요. NEJM/Lancet/FDA 1차 자료 직접 인용 패턴 정립.
...
- GLP-1 비만치료제 적응증 확대 (OSA, MASH, CKD, Alzheimer 등) — NEJM 3상 결과
- FDA Accelerated Approval Reform 영향 (임상2상 가속 승인 기준 변화)
- IRA Medicare Drug Price Negotiation 영향 — 2026 protocol 16개 약물
- China biotech (BeOne, BeiGene) 글로벌 시장 진출
- CRISPR/유전자치료 (Casgevy 사례) 상용화 + 보험 커버리지
- M&A 사이클 (대형 제약사 + 중소 biotech)
...
- 2026-09 `wegovy_semaglutide_mash_fda_202609.md` — FDA Wegovy(세마글루타이드 2.4mg) 비경변성 MASH(F2-F3) 가속승인(2025-08) — 첫 GLP-1 간질환 적응증, ESSENCE 72주 MASH 관해 63% vs 위약 34%(+29%p)·섬유화 개선 37% vs 22% + 미국 MASH ~6%(1,500만명), Rezdiffra 이후 두 번째 (GLP-1 심대사→간질환 확장 축)
...
- 대형 제약 (LLY, NVO, JNJ, MRK, ABBV) → NEJM 3상 + IRA 협상 가격 L2
- biotech (REGN, VRTX, GILD, BIIB) → 임상 파이프라인 + FDA AdCom L2
- 의료기기 (ISRG, MDT, ABT, BSX) → FDA 510(k) + AHA conference L2
- ETF (XBI, IBB, XPH) → biotech 사이클 + M&A 빈도 NBER L2

## 관련 KB 교차 참조

- `knowledge-base/industry/biotech.md`
- `knowledge-base/industry/healthcare.md`
- `knowledge-base/macro/political_cycle.md` — IRA 정치 영향
