...
## CURRENT (2026-04-30 모닝 갱신 — 04-29 빅테크 AH 실적 + FOMC 반영)

### 최근 30일 서프라이즈 누적 (Beat/Miss) — 04-30 모닝 갱신

| 지역 | Beat | Miss | 중립 | 누적 스코어 | 방향성 |
|------|------|------|------|-----------|--------|
| **미국** | **23** | **4** | **7** | **+0.56** | Beat 강화 — MSFT/AMZN/GOOGL Beat 3건 추가. META EPS Beat(+1) / CapEx 상향 매도(시장 반응 부정적이나 서프라이즈 판정 기준상 Beat). GDP/PCE 4/30 미발표. AAPL 4/30 장후 미발표 |
| **유로존** | 2 | 1 | 3 | **+0.17** | 소폭 개선 유지 — ECB 4/30 25bp 인하 컨센서스. 추가 지표 미발표 |
| **중국** | 4 | 0 | 1 | **+0.80** | 강력 Beat 유지 — GDP +5.0% / PMI 51.2 / 수출 +12%. 신규 지표 미발표 |
| **한국** | 6 | 0 | 1 | **+0.86** | 극Beat 강화 유지 — Q1 GDP +1.7%(컨센 +0.9% 상회). KOSPI 6,690 신고가 4월 글로벌 최강 |
