...
> **갱신 주기:** 매 거래일 (30일/90일 롤링)
> **쓰기 권한:** correlation-monitor
> **읽기 권한:** briefing-lead, briefing-report-generator, global-macro-analyst
...
|---|------|-------------|-------------|----------|--------|-------------|-------|
| 1 | S&P 500 ↔ 미국 10Y 국채금리 | *(미수집)* | | | | | 🟢 |
| 2 | NASDAQ ↔ BTC | *(미수집)* | | | | | 🟢 |
| 3 | USD/KRW ↔ KOSPI | *(미수집)* | | | | | 🟢 |
| 4 | Gold ↔ DXY (달러인덱스) | *(미수집)* | | | | | 🟢 |
| 5 | VIX ↔ S&P 500 | *(미수집)* | | | | | 🟢 |
| 6 | WTI ↔ 미국 10Y 인플레이션기대 | *(미수집)* | | | | | 🟢 |
