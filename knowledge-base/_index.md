...
> [v3.10.2 신규 — 04-24]: education.md 신규 (에듀테크·온라인교육·대학·직업훈련·AI교육·교육출판 공백 해소). 총 industry KB 24개 체제.
...
| `changelog_2026.jsonl` | 59건 (+1 @2026-04-24: banking_capital Q1 2026 갱신) | kb-updater |
...
| 날짜 | 파일 | 변경 | 레코드 |
|------|------|------|-------|
| 2026-04-24 | `industry/education.md` | **신규 생성** — 교육·에듀테크·대학·직업훈련·AI교육·교육출판 섹터 KB 공백 해소. 글로벌 에듀테크 $404B(HolonIQ·AI교육 +42%) + 미국 에듀테크(DUOL Q4 2025 $1.04B+39%·DAU 52.7M·2026 DAU 최우선 피벗·1월 -20% 폭락 / COUR Q1 2026 신규 7.6M but 가이던스 재확인 급락 / CHGG 2025 -36.7%·2025-10 45% 감원·$1 미만 distressed / LRN Q1 FY26 $620.9M+13%) + 한국 에듀테크(메가스터디 2026 회복·웅진씽크빅 2025 -104억 적자전환·대교 학령인구 직격) + 대학(미국 등록금 사립 $63K·Trump 하버드 $2.3B 동결 2025-09 위법 판결·교육부 해체 EO 2025-03-20·$1.7T 학생대출 재무부 이관·SAVE plan 종료 7.5M·PSLF 해체 / 한국 학령인구 47만·지방대 6:1 미만·등록금 190교 중 125교 인상·사립 80.8% vs 국공립 7.7%·의대 지역인재 강제) + OPM(2U 2024-07 Ch11 파산 $800M edX+Trilogy 부채·Coursera+Udemy 합병 2026H2) + AI교육(ChatGPT Edu 35+공립대·70만 라이선스·Cal State $17M·대학생 1/3 정기사용 / Khanmigo GPT-4 / Claude for Education / Gemini×Classroom 2026-02) + Upskilling(LinkedIn Learning 21K강좌·Coursera for Business·Udemy Business 25K·패스트캠퍼스 기업출강 60% AI·한국 정부 AI·디지털 30+ 집중캠프 38개교) + 교육출판(Wiley Q3 FY26 EPS $0.97 beat·AI매출 YTD $42M 전년초과·Pearson×AWS 2026-04-13). **선호**: DUOL·LRN·WLY·웅진씽크빅 turnaround. **회피**: CHGG distressed·2U Ch11·대교 학령인구. **총 industry KB 24개 체제** | +42 |
| 2026-04-24 | `industry/banking_capital.md` | **Q1 2026 실적 시즌 갱신** (updated 2026-04-21→2026-04-24). 한국 4대 FH 1Q26 실적 진행: **KB 1.8924조 확정(+11.5%, 분기 역대 최대) + 2.9조 자사주 소각(업계 최대)**, 신한 1.55조(+4.0%), 하나 4/24 발표, 우리 0.77조(+24.8%), 4대 합산 5.2371조(+6.2%, 1Q 첫 5조 돌파). **NH증권 Q1 OP 6,367억 record(+120.3%)**, 5대 증권 OP 컨센 3조. 미국 대형은행 1Q26: JPM EPS $5.94 Beat(NII가이던스 $103B 하향), BAC NII 가이던스 상향 +6~8%, C 순익 +42%, WFC 미달, USB/PNC CRE 11분기 감소 후 복귀. **글로벌 M&A Q1 $1.2조(+42% YoY record)**, GS Advisory +89% $1.49B 1위($267B) — **GS 2026-04-23 Buy 83.9 A- 분석 완료 연동**, MS IB +36%. BlackRock AUM $13.9T·EPS $12.53 Beat, Blackstone $1.3T record. **Basel III Endgame 2026-03-19 재공표·Q4 최종 예정·$250B 이하 면제**. 미 CRE Wall **$1.5조 2026 만기** (이전 $539B 상향). BOK 2.50% 7연속, 신현송 인상 시사. 한국 ETF **400조 돌파(4/15)**. KKR/APO 2026-02 -10%+ AI SaaS 충격. 카카오페이 매출 +30%·OP +491% | +31 (64→95) |
| 2026-04-24 | `industry/healthcare_service.md` | **신규 생성** — 헬스케어 서비스·의료기기·디지털헬스 섹터 KB 공백 해소. Payer(UNH/ELV/HUM/CNC 4사 2026 Q1) + 병원(HCA/THC/UHS 2026 가이던스·Medicaid 삭감 66% CFO 1순위) + 의료기기(ISRG/SYK/EW/BSX/GEHC/MDT/ABT 2026 Q1 실적·가이던스) + 디지털헬스(HIMS/TDOC/DOCS/TEM/VEEV) + 약국(CVS 28.4%·Amazon 19.7%→45% 접근) + CRO/CDMO(IQV/LH/삼성바이오 OPM 46% Lonza 2배·셀트리온·Lonza·Catalent) + 한국 AI의료(루닛 831억·뷰노 348억) + 정책(IRA Part D 10개 2026-01 발효 $6B/yr·BIOSECURE Act 2025-12-18 서명·$10-20B 전환·Trump MFN EO 2026-04-02 16개사 자발·Medicaid Safety-net -25~-30% 마진·2027 MA rate +0.09% HUM/UNH -20%). **선호**: ISRG/EW 가이던스 상향, 삼성바이오 BIOSECURE 반사이익. **회피**: HUM EPS 쇼크, BSX 가이던스 하향, Safety-net 병원 DSH 삭감 | +47 |
| 2026-04-24 | `industry/food_agriculture.md` | **신규 생성** — 식품·농업·AgTech 섹터 KB 공백 해소. 곡물가격(USDA WASDE 옥수수 $4.15·대두 $10.30·밀 $5.00 상향·CBOT 실거래·cocoa 2024 peak→2026 -6%·엘니뇨 61%) + 비료·농화학(CF/MOS/NTR fertilizer rally·CTVA 2026 EPS $3.45-3.70·Bayer $7.25B Roundup 합의) + 농기계(DE Q1 FY26 EPS $2.42 beat·FY26 net income $4.5-5B 상향·관세 $1.2B '사이클 바닥'·CNH/AGCO 역풍) + AgTech(정밀농업 2031E $17.29B·자율농기계 CAGR 15%·수직농장 2025 파산 14건 Plenty/Bowery·BYND 상장폐지 경고 vs Oatly 첫 흑자) + 식품가공(TSN Q1 $14.3B·GIS -7%·KHC -2.4%·K-Food 2025 $12.3B 사상최고·삼양식품 3Q OP 3,850억) + 식량안보(한국 곡물자급률 19.5%·미중 2026-2028 대두 2,500만톤 합의·인도 밀 수출재개·미국 농산물 수출 2026E -$9B) + 기후·ESG(IPCC 농업 22%·No-tillage CO2 -47%·ICVCM 농업 탄소크레딧 첫 승인) + FDA MAHA UPF 규제. **총 industry KB 23개 체제** | +57 |
