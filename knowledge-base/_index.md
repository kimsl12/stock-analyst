...
| `energy.md` | **Brent $111.04(+10.5%), WTI $105.42**(주간+11%). JKM $17.11(-7.3%), 정제마진 ~$19~20(안정), Henry Hub $2.96 | **EIA STEO May: 5~6월 $106, 2Q26 재고 -8.5Mbpd(역대최대)**. 걸프 10.5Mbpd shut-in. IEA 10월까지 공급부족. 이란 MOU 14항 임박(Axios)이나 의회반대(52+177)+신규제재. Project Freedom 중단(5/6). NuScale $11.22(Citi $7). 한화솔루션 CBP해소(+80%출하/+14%판가). 한전 TP48K(키움하향). OPEC+ 6/7 회의. Meta 6.6GW 원자력 | 05-17 | 06-16 | high |
| `science_tech.md` | 한국 R&D/GDP **5.1%**(OECD 2위), 글로벌 R&D 3.8조달러, 정부 R&D **35.5조**(+19.9%) | **양자**: Quantinuum IPO **$1.5B/QNT** Nasdaq+H2 QV 2^25. IonQ/D-Wave 5주2배. **바이오**: Survodutide Ph3 -16.6%. Foundayo Amazon $149/월. **우주**: Starship V3 **5/19**(Pad2+V3 데뷔). Neutron Q4. **로보틱스**: Optimus V3 7~8월. **사이버**: RSAC 완결+PANW AI공격경고+CRWD Agentic MDR. **CapEx**: $725B+2027E $1T+. MS RPO $627B. AMAT 사상최대. **한국**: SK하이닉스 OP 37.6조+삼성밸류역전. 네이버/카카오 역대최대 | 05-17 | 06-16 | high |
...
| `political_cycle.md` | **Warsh 5/13인준(54-45역대분열)+5/15취임완료. 파월이사직잔류(75년선례파괴). 미중정상회담완료(외화내빈): 보잉200대+BoT+관세휴전유지이나 실질인하0. H200 10개사승인이나 중국차단(출하0건). 이란MOU 합의희망소멸(트럼프"인내심바닥"). WTI $105(+11%주간). KOSPI 8,046→7,493(-6.12%폭락/외인1.8조). Section301 7월말최종결과대기. ECB 6월불확실증가. BOJ 6월1.0% 2/3예상. 중간선거 민주하원탈환유력. 지방선거D-17 민주9~13곳** | 이란딜 합의희망소멸→WTI $100+고착→연내인하0회강화. Warsh QT가속시 유동성축소. 미중외화내빈→Section301 7월차등관세불가피. KOSPI 8000폭락후 변동성확대. ECB/BOJ 6월결정이 글로벌자산 방향결정 | 05-17 | ✅ high |
| `tech_breakthrough.md` | **AI: Intelligence Index plateau(프론티어 신모델 없음)·SubQ subquadratic 12M컨텍스트, Snowflake+OpenAI $200M 에이전틱·MCP 9,700만DL·"실험 종료" 선언, EU AI Omnibus 5/7 고위험 2028 연장·누디파이어 금지. 반도체: TSMC N2 월5만매 안정·전량매진·CAGR70%, Intel 18A Apple 확정(2027), CoWoS+SoIC 5/14 18팹 확장. 에너지: DOE Tier2 $100M SMR·EU SMR Valley, Samsung SDI 500Wh/kg 2027양산. 바이오: Wegovy 경구 첫감소(137K)·Foundayo +40% WoW·Medicare 7/1 커버, Beam hATTR 가속승인 합의. 양자: Google REPLIQA $10M·IonQ Boulder R&D랩. 로봇: Tesla Optimus Gen3 7~8월 양산·CA FSD 판매금지 위협, Waymo 25만회/주·중상해91%↓. 우주: Starship V3 5/19 초도비행·10,296궤도. 신소재: EPFL 삼중접합 30.02% 신기록** | 8개 서브섹터 주간 갱신(+16 DB). 양자AI 신규 행. Disruption Map 수치 갱신 | 05-17 | ✅ high |
...
| `energy_2026.jsonl` | 217건 (+13 @2026-05-17) | kb-updater |
| `geopolitics_2026.jsonl` | 117건 (+26 @2026-05-03) | kb-updater |
| `science_tech_2026.jsonl` | 623건 (quantum/space/smr/biotech/eda/cybersecurity subtag 포함, +23 @2026-05-17 갱신) | kb-updater |
...
| 2026-05-17 | `macro/geopolitics.md` (SSOT) | **지정학 주간 갱신(12회 검색, +8 DB 레코드)** -- 미중 정상회담 **완료**: 보잉200대+BoT구상($30B감면검토)+희토류1년유지. 이란MOU **교착+annihilation경고(5/15)**. 중국 **~30척 IRGC 조율 호르무즈 특혜통과** vs 비중국 봉쇄유지(이중구조). WTI **$105.42(+11%주간)**. 러-우 **3일휴전만료→작전재개(5/12)**. 인도-파키스탄 **Op신두르1주년+Marka-e-Haq Day**. 한국 **단계적기여검토(5/12)+26개국공동성명(5/15)** | +8 |
| 2026-05-17 | `macro/political_cycle.md` (SSOT) | **정치사이클 주간 갱신(12회 검색, +10 DB 레코드)** -- Warsh **5/13 인준(54-45 역대분열)+5/15 취임완료**. 파월 이사직잔류(75년선례파괴). 미중정상회담 **완료(외화내빈)**: 보잉200대+Board of Trade+관세휴전유지이나 **실질인하0**. Nvidia H200 **10개사승인이나 중국차단(출하0건)**. 이란MOU **합의희망소멸**(트럼프"인내심바닥"). WTI **$105(+11%주간)**. KOSPI **8,046→7,493(-6.12%폭락/외인1.8조)**. ECB 6월 **불확실증가**. BOJ 6월 **1.0% Reuters 2/3예상** | +10 |
| 2026-05-17 | `industry/energy.md` | **에너지 주간 갱신(10회 검색, +13 DB 레코드)** -- 유가 급등 반전: WTI **$105.42(+10.5%주간)**, Brent **$111.04(+8.1%주간)**. EIA STEO May: **Brent 5~6월 $106 전망, 2Q26 재고 -8.5Mbpd(역대최대)**. 걸프 **10.5Mbpd shut-in**. IEA **10월까지 공급부족**. 이란 MOU 14항 임박(Axios)이나 **의회반대(상원52+하원177)**+신규제재(5/12). Project Freedom **중단(5/6)**. 1,550척좌초. JKM **$17.11(-7.3%)**. NuScale **$11.22(-16%, Citi $7)**. 한화솔루션 **CBP해소+출하+80%+판가+14%**. 한전 키움 **TP 48K(하향)** | +13 |
| 2026-05-17 | `macro/global_risk_factors.md` (SSOT) | **글로벌 리스크 맵 주간 갱신(13회 검색, +20 DB 레코드)** -- CPI **3.8%(3년최고)**+10Y **4.59%(+21bp)**+금리인상 기대 **50%+** = 인플레 쇼크 주간. S&P **7,501(ATH 5/14)->7,409(-1.24%)**. KOSPI **8,047(ATH)->7,493(-6.12% 급락)+외국인5.6조매도**. 원/달러 **1,500.8(1500돌파)**. WTI **$106(+11% 주간)**. Warsh **54-45 인준(5/13)**. 트럼프-시진핑 **구체합의0건**. 이란 **역제안거부+봉쇄지속**. 침체확률 GS25%/JPM40%. VIX 18.43. Gold $4,548(-3.7%). BTC $78,150(-2.8%) | +20 |
