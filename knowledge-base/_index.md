...
| 날짜 | 파일 | 변경 | 레코드 |
| 2026-05-16 | `industry/advanced_materials.md` | **첨단소재 8개 서브섹터 갱신(12회 검색, +37 DB 레코드)** -- Wolfspeed FQ3 $150M(-28% 대폭 미스/GPM -27%/YTD+180% 괴리). onsemi Q1 $1.513B(자동차+5%/GaN $1.5B 파이프라인/수직형 700V·1200V). Navitas Q1 $8.6M(AI+50%/20kW PDB 97.5%). OCSiAl 세르비아 3,000t/y. IBM 그래핀 트랜지스터(-40% 전력). 삼성SDI 전고체 2027 양산+CATL Naxtra Na-ion GWh 양산+LMFP M3P/Blade 양산. NdPr $99.61/kg 5월 반등 조짐. 미-호주 핵심광물 $3B+. Lynas Kalgoorlie 12K t/y 확대. CFS SPARC 65% 완료+DOE 검증. 항공우주 소재 $30.2B. 48D 35% 확정(법안 서명) | +37 |
