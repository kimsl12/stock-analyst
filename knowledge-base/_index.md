...
| `quantum.md` | **IonQ Q1 $64.7M(+755%)**, FY2026 **$260-270M(상향)**, RPO $470M(+554%), SkyWater FTC 진행중, Quantinuum IPO mid-2026($20B+), 양자센서 $502M-984M(국방40%), **CISA PQC 연방의무화** | **IBM 12,635원자 단백질 시뮬레이션**(05-05, Cleveland Clinic-RIKEN). Quantinuum-**BMW 다년 파트너십**(05-05). Rigetti **99.9% 2큐빗 게이트**(Adiabatic CZ 28ns). PsiQuantum CEO Victor Peng+**Intel Lip-Bu Tan** 이사회. Infleqtion NASA 양자중력계 ~2030. QuEra-NVIDIA NVQLink GPU-QPU. 한국 Quantum KOREA 2026(07/02~04). IONQ ~$52.50(YTD+16%) | 05-09 | 06-09 | high |
| `space.md` | 우주경제 $626B(2025), Starlink **10,020기+**/1,000만, SpaceX **$1.75T IPO 6/8 로드쇼**, Falcon 9 **55회**(5/6), **RKLB Q1 $200.3M(+63.5%)**, 우주군 $26B+Golden Dome **$185B**, **KASA 1조원 예산**, LUNR $800M Lanteris 인수 | Starship V3 IFT-12 **5/15 발사 목표**(지연). SpaceX IPO 6월말~7월초 Nasdaq $75B+ 조달. **RKLB Q1 역대최고+주가+34%+백로그 $2.2B**. Blue Origin FAA **비행정지 장기화(복귀일 미정)**. Amazon Leo **700기 예상(7월)**/FCC 미결. ASTS BB8~10 **Falcon 9 전환**(6월중순)/45~60기 목표상향. **Artemis III 지구궤도 테스트로 변경**(달착륙->Artemis IV 2028). Golden Dome SBI 2028 프로토타입. LUNR FY26E $900M~$1B | 05-09 | 06-09 | high |
| `smr.md` | TerraPower 4/23 착공(2030~31 완공)+**Meta 8기 계약(최대4GW)**. X-energy IPO $1.02B(XE $30.05). **BWXT Q1 $860M(+26%/EPS $1.12 비트/잔고$8.65B+77%/가이던스 상향)**. NuScale Q1 매출$0.6M(-95.5%/실적부진). Oklo 4월+46%/NRC PDC가속승인. NRC Part53/Part57(5/1 연방관보). CFS 자석 여름완료. 두산 131K신고/5배→6.4배. 한국 핵융합 제5차기본계획 착수(5/7) | ITER VV 8개섹터수령+중앙솔레노이드 완납. RR-SMR GDA 12월완료예상(유일최종단계). X-energy Centrica UK 6GW 신규. Part57 제안규칙 공개의견6/15마감. NANO-Supermicro MOU(비구속). Helion Orion Malaga 착공완료(2025.07). TAE-TMTG 2026중반 완결예정 | 05-09 | 06-09 | high |
...
| `advanced_materials.md` | **6개 서브섹터 주간 갱신**(CNT/그래핀/초전도체/SiC-GaN-세라믹/희토류/정책). **NdPr $99.61/kg(Q1+105%후 4월-21% 조정, YTD+88%)**. Dy $223/kg(보합). OCSiAl-Molicel SWCNT 파트너십(260Wh/kg). CFS SPARC 첫 자석 설치($3B 투자). Navitas-GF GaN 미국 제조 파트너십. onsemi 부천 200mm SiC 램프업. 48D 25->35% 인상 | **가격 급변**: NdPr Q1 +105% $99.61/kg 조정, 중국 수출통제 시진핑-트럼프 합의 유예 중. **MP Materials HREE mid-2026 가동+Lynas Dy/Tb 첫 출하**. Hybrid Graphene-Si 칩 최초 출시. 그래핀스퀘어 2026 투과도96%+ 목표. 호주 Iluka $1.65B AUD 대출. 한국 희토류 TF·수급대응센터 가동. 포스코 아르헨티나 리튬 1단계 흑자 전환 | 05-09 | 06-09 | high |
...
| `capex.md` | Q1 실적+5/9 갱신: TrendForce 9사 합산 **$830B(+79% YoY)**. 5사 $775-805B. AWS **$230B+**(상향). MSFT $190B. GOOGL $180-190B(+100%+). Meta $125-145B. Apple **$14B**(빅테크 최소). TSMC $52-56B. ASML EUR36-40B. 유틸리티 $1.4T. DC CapEx 2029 $1.2T(Dell'Oro). IEA DC 전력 **1,000TWh+** | SK하이닉스 OP 37.6조(OPM 72%, HBM 3년완판). 삼성 **110조+CapEx(+128%)**. Intel flat~down(SK·Micron에 추월). **LTA 확산**(삼성 3~5년, SK 중장기). SK증권 목표주가 삼성50만/하이닉스300만. **SMR 파이프라인 45GW(+80%)**. Meta-Oklo 1.2GW. GS 2026-2031 $7.6T. 2027 $1T+(CNBC). HBM $54.6B(+58%) | 05-09 | 06-09 | high |
...
|------|---------|-----------|-------|-------|
| `us_economy.md` | **4월 NFP +115K(골디락스, 예상62K 대폭상회), 임금 +3.6%(예상3.8% 하회), 실업률 4.3%(보합), Core PCE 3.2%, ISM제조가격 84.6+서비스가격 70.7, Q1 GDP +2.0%, GDPNow Q2 +3.7%, Fed 3.50~3.75%(6월동결96%), 10Y 4.38%, S| `us_economy.md` | **CPI 3.3%(에너지 주도), Core CPI 2.6%, Core PCE 3.2%(2024.01래 최고), ISM제조가격 84.6+서비스가격 70.7(양부문 극단), Q1 GDP +2.0%, Fed 3.50~3.75%(4명반대), 10Y 4.38%, DXY 98.42, S&P 7,365(신고가), WTI $95.66(이란 합의 기대 -10%), 침체확률 25~35%, ADP 4월 +109K, JOLTS 6.9M, 저축률 3.6%(2008래 최저), 미시간심리 49.8(역대최저), 가솔린 $4.45~4.58/gal(+8% MoM)** | 이란 5/8 답변(단일 최대 변수). Warsh 5/11 인준+5/15 취임(forward guidance 폐지/QT가속). Tim Scott 파월 잔류 비판(5/5). GS 관세 72% 전가. ISM 양부문 고용 수축(제조46.4/서비스48.0). 5/8 고용+미시간+이란 트리플 이벤트 | 05-07 | ✅ high |P ~7,435(6주연속 신고가), NASDAQ 26,247(26K 최초), WTI $95.78, DXY 98.16, 미시간5월예비 48.2(현재상황47.8 역대최저), 인플레기대 1년 4.5%(4.7%에서 하락), 저축률 3.6%, 가솔린 $4.55/gal(+$1.40 YoY)** | 이란 5/8 호르무즈 양측포격(정전 기술적 유지). Warsh 5/11 cloture+5/15 취임. 5/12 4월CPI(Core 3.2% 피크 전망). ISM 양부문 고용 수축 vs NFP 괴리. K자형 소비 분화(상위+6% vs 하위+1.5%). 가솔린 $4.55 소비 전환점 | 05-09 | ✅ high |
...
| `korea_economy.md` | **Q1 GDP +1.7%(5.5년최고, YoY +3.6%), 전산업생산 +1.7%(17분기최대), GDI +7.5%(38년최고), 4월 수출 $85.89B(+48.0% 역대2위)+무역흑자 $23.77B(역대4월최대), 반도체 $31.9B(+173.5%/13개월연속역대), 3월 경상수지 $37.33B(사상최대/35개월연속흑자), KOSPI 5/8 7,498(7000시대), 외국인 5/4+5/6 +6.13조→5/7+5/8 -12.74조 차익실현, 증권가연말 8,000~8,600, 금리 2.50%(7연속동결), BOK 매파전환 공식화(유상대 인상사이클전환), 원화 1,445~1,462, WGBI 1개월10조유입+장기물비중확대, SK증권 삼성50만/하이닉스300만, CPI 4월 2.6%(가속/1년9개월최고), CPI 연간컨센 2.5%(38개기관상향), 외환보유 $4,278.8억(+42.2억), CCSI 99.2(1년래100하회)** | BOK 매파전환 공식화(5/4~5/5)+5/28 K-dotplot 상향+Citi 연말3.00%. 3월 경상흑자 $37.33B 사상최대(5/8 BOK). CPI 4월 2.6%→5월 3% 접근(유가). 외국인 변동성 확대(6.13조 순매수→12.74조 차익실현). 2차추경론 but 정부 부인 | 05-09 | ✅ high |
...
| `advanced_materials_2026.jsonl` | 214건 (+29 @2026-05-09 주간 갱신) | kb-updater |
| `battery_2026.jsonl` | 110건 (+70 @2026-04-21) | kb-updater |
| `infrastructure_2026.jsonl` | 63건 (+39 @2026-04-21) | kb-updater |
| `capex_2026.jsonl` | 65건 (+11 @2026-05-09 주간 갱신) | kb-updater |
| `smr_2026.jsonl` | 74건 (+29 @2026-05-09 주간 갱신) | kb-updater |
...
| `quantum_2026.jsonl` | 33건 (+15 @2026-05-09 주간 갱신, industry/quantum.md SSOT) | kb-updater |
...
| 원/달러 | `macro/korea_economy.md`: 1,445~1,462원 (05-09 갱신, 5/9 시가 1,445.48) | `market/daily_snapshot.md`: 1,473.21 오픈 / 1,467.90~1,477.18 (05-06 KST 오전) | 05-09 | ✅ korea_economy.md 05-09 갱신 완료 (원화 강세 반영) |
...
| 2026-05-09 | `industry/advanced_materials.md` | **첨단소재 6개 서브섹터 주간 갱신(12회 검색, +29 DB 레코드)** -- 희토류 가격 급변(NdPr $99.61/kg, Q1+105%후 4월-21% 조정). 중국 수출통제 시진핑-트럼프 유예 확인. MP Materials HREE 분리 mid-2026 가동+Lynas Dy/Tb 첫 출하. CFS SPARC 첫 자석 설치(총$3B). Navitas-GlobalFoundries GaN 미국 제조 파트너십. onsemi 부천 200mm SiC 램프업 성공. OCSiAl-Molicel SWCNT 파트너십(260Wh/kg). Hybrid Graphene-Si 칩 최초 상용 출시. 호주 Iluka $1.65B AUD. 한국 희토류 TF+수급대응센터. 포스코 아르헨티나 리튬 1단계 흑자 | +29 |
| 2026-05-09 | `industry/telecom_next.md` | **차세대통신 주간 갱신(13회 검색, +19 DB 레코드)** -- SKT Q1 확정(OP 5,376억/-5.3%/AIDC+89.3%), LGU+ Q1 확정(OP 2,723억/+6.6%, 유일성장). AST BlueBird 6월중순 Falcon9 3기 복구발사 발표(5/6). Starlink 매출 $12.3B(확정)/2026E $18~19B(+80%). SpaceX IPO $1.25~2T. NVIDIA **Nemotron Telco 30B** 오픈소스+IEEE ICC 2026(5/24~28). SoftBank AI-RAN 여유컴퓨팅 3rd-party AI 실행 데모. O-RAN 10th 6G워크숍+PQC보안+nGRG-ISAC(6/4). Samsung-Vodafone vRAN 음성성공(Xeon6+Dell+Wind River, 2026 상용). X105 Q3 Snapdragon 8 Elite Gen6/Galaxy S27 탑재유력. Rel-20 발간 2027.06. Iridium NTN Direct Rel-19 기반 확인. 유럽 5대MNO D2D 2026여름 트라이얼 | +19 |
| 2026-05-09 | `industry/smr.md` | **SMR/핵융합 주간 갱신(13회 검색, +29 DB 레코드)** -- TerraPower-**Meta 최대8기 Natrium 계약**(2032~2035, 듀얼유닛 4GW). NuScale Q1 **매출$0.6M(-95.5%)**/EPS -$0.14(시간외-4.64%). **BWXT Q1 $860M(+26%)/EPS $1.12(+21.7% 비트, 5분기연속)/잔고$8.65B(+77%)/가이던스 전면상향**. X-energy $30.05(IPO+30.7%)+**Centrica UK 6GW** 신규. Oklo **4월+46.2%**+NRC PDC 가속승인. Part57 **연방관보 게재(5/1)**/의견마감6/15. CFS **자석 여름까지 완료**. 두산 131K/**52주고131.1K**(6.4배). **한국 핵융합 제5차기본계획(2027~31) 착수**(5/7)+ITER 누적1조/신규211억. ITER VV 8섹터+중앙솔레노이드 완납. NANO-Supermicro MOU(5/6) | +29 |
| 2026-05-09 | `industry/space.md` | **우주산업 주간 갱신(11회 검색, +25 DB 레코드)** -- Starship V3 IFT-12 **5/15 목표**(5/12에서 지연, Pad 2 첫 사용, splashdown). Falcon 9 **55회(5/6)**. SpaceX IPO **6/8 로드쇼/$1.75T/$75B+**(역대최대). RKLB Q1 **$200.3M(+63.5%)**/백로그 $2.2B/주가 **+34%**/Q2 $225~240M 가이던스. Blue Origin **비행정지 장기화**(복귀일 미정). ASTS BB8~10 **Falcon 9 전환**(6월중순)/45~60기 목표상향. Amazon Leo **700기 예상(7월)**/**FCC 미결**. **KASA 1조원 예산** 시대. Golden Dome SBI 2028 프로토타입 | +25 |
| 2026-05-09 | `industry/capex.md` | **CapEx 주간 갱신(10회 검색, +11 DB 레코드)** -- TrendForce 9사 합산 **$830B(+79% YoY, 기존 +61% 대비 상향)**. AWS **$230B+(기존 $200B 상향)**. Apple **$14B(빅테크 최소)** 신규 추가. 삼성 반도체 **110조+($73.2B, +128% YoY, 역대 최대)**. Intel flat~down(SK하이닉스·Micron에 추월). **LTA 확산**(삼성 3~5년/SK 중장기). SK증권 목표주가 삼성50만/하이닉스300만 상향. **SMR 파이프라인 25GW→45GW(+80%)**. Meta-Oklo 1.2GW+TMI-1 835MW 재가동 2027. IEA DC 전력 **1,000TWh+**. Dell'Oro DC CapEx **$1.2T(2029, CAGR 21%)**. 5G 가입 **30억 돌파(Omdia)** | +11 |
...
| 2026-05-09 | `macro/supply_chain.md` | **공급망 주간 갱신(18회 검색, +26 DB 레코드)** -- WCI $2,286(+3%반등/3주하락후전환), Brent $104/WTI $94~98(호르무즈교전재개5/7~8), 이란MOU **미서명**(핵비협상+역제안14개항+양측격차), 구리COMEX $6.24(+1.9%/주간+3%/사상최고재도전), 요소비료$616(+6.7%반등/합의교착), FAO 130.7(상향), TSMC 5팹동시양산(80~140K/월), Intel 18A HVM개시(미국첫sub-2nm), LNG TTF+35%/JKM+51%(카타르시설수리5년), Section301 공청회5/5~8완료, Section122 연장위원회미통과, 중국희토류행정집행강화(4/29), 시나리오Bear45%상향(MOU교착+교전) | +26 |
