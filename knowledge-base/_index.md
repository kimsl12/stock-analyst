...
| `science_tech.md` | 한국 R&D/GDP **5.1%**(세계 1위), 글로벌 R&D 3.8조달러, 정부 R&D **35.3조**(+21.4%) | **양자 산업 변곡점**: IonQ SkyWater $1.8B+Quantinuum $20B IPO+CISA PQC 의무화. **우주 대형 이벤트**: Artemis II 성공+SpaceX $1.75T IPO+Starlink 11,856기+NG-3 BlueBird7 손실+Golden Dome $3.2B. **SMR/핵융합**: TerraPower NRC 건설허가+착공(최초 상업 첨단원자로)+CFS SPARC 2026 first plasma+Helion 최초 D-T 핵융합+민간 $10B+. 경구 Wegovy. 빅테크 CapEx $7000억. Optimus Gen3 자율보행 | 04-25 | 05-25 | high |
...
| 2026-04-25 | `industry/science_tech.md` | **SMR/핵융합 섹션 deep 갱신** -- TerraPower Natrium NRC 건설허가(03.04)+착공(04.23) 최초 상업 첨단원자로. Holtec SMR-300 NRC 수리(02.13). Rolls-Royce UK GDA Step 3(유일). 두산에너빌리티 수주 14.7조(+107%)+SMR공장 착공(8,068억). X-energy 2026말 허가 가능. 빅테크 원전 PPA 10GW+. CFS SPARC 자석설치->2026 first plasma 목표. Helion 최초 민간 D-T 핵융합+1.5억℃. TAE-TMTG $6B 합병. KSTAR 102초. EAST 1,066초. 민간 핵융합 $10B+ 누적. HALEU 연료 병목 리스크 추가 | +25 |
