...
| **★232 결정 지연·스프레드**        | **Trump 행정부 정제구리 관세 결정 지연 보도(주중 구리 multi-week 저점 유발). COMEX-LME 스프레드 정상 $50→>$800/t(232 불확실성). 단계관세 15%(2027)→30%(2028) 미결** | TradingEconomics/CNBC 09월, DiscoveryAlert  |
