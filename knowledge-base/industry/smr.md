**SMR / 핵융합 (CURRENT)**
- **요약:** SMR(소형모듈원전)과 핵융합(상업용 데모)은 저탄소 분산발전·그리드 보완·국가 에너지 안보 관점에서 관심이 증가하고 있습니다.
- **주요 출처:** IAEA, US DOE, ITER, NuScale, Rolls‑Royce SMR, KAERI/KHNP, World Nuclear 등 공식 페이지 및 기업 보도자료.
- **주요 포인트:**
  - 정책·재정(정부 데모·보조금)과 규제(설계·라이선싱 경로)가 상이한 국가별로 진행 중
  - NuScale/롤스로이스/한국(KAERI·KHNP) 등 상용·시범 후보군이 존재
