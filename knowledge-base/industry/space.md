...
| 항목 | 수치 | 비고 |
|------|------|------|
| 글로벌 우주경제 규모 (2025) | **$626B** | SpaceNews/Orbital Radar 확정 |
| 우주경제 CAGR | 12% | $1T by 2032~2034 (Orbital Radar/Novaspace) |
| 장기 전망 (2035E) | **$1.8T** | McKinsey/WEF 공동 전망 |
| 상업 활동 비중 | 78% | 정부/군사 22% |
| 위성서비스 시장 | ~$180B | 최대 단일 세그먼트 (통신+관측+항법) |
| 위성제조 매출 (2024) | $20B | +17% YoY |
| 위성 브로드밴드 (2030E) | $40B | 최고 성장 서브세그먼트 |
| 지구관측 CAGR | 15% | 기후/농업/국방 수요 |
...
- **Terran R**: CDR 완료, 비행 생산 개시
- 1단 구조물 8개 배럴 완성, Aeon R 1.3 엔진 최종 개발 캠페인
- 2단 탱크 기계 조립 완료 (LOX 리드, 추력 콘, 헤드밴드)
- **첫 비행: 2026 H2** (Cape Canaveral LC-16)
- SES와 다중 발사 계약 확대, 3D프린팅 핵심 기술
...
| 항목 | 수치 | 비고 |
|------|------|------|
| **가입자 수 (2026.02)** | **1,000만+** | 2024.09 400만 -> 2025.12 900만 -> 2026.02 1,000만 |
| **활성 위성** | **10,020기+** | LEO 운용 |
| 발사 누적 | 11,856기+ | 4/17 기준 |
| 서비스 국가 | 75개국+ | 125~155개 영토/지역 |
| DTC 위성 수 | 650기+ | 세계 최대 4G 커버리지 |
| DTC 월 이용자 | **600만+** | 22개국 서비스 |
| 2026E 매출 | $15.9~24B | Bloomberg/Quilty Space |

- **Starlink Mobile (리브랜딩)**: DTC 서비스를 "Starlink Mobile"로 공식 리브랜딩
- 텍스트 + 음성 + 데이터(Google Maps, WhatsApp 등 30개 앱) 지원
- **2026년 말 2,500만 DTC 이용자 목표**
...
- **2026.04.08 엔터프라이즈 베타 공식 개시** (3개 터미널 티어)
- 베타 고객: Verizon, AT&T, Vodafone, JetBlue, NASA, Hunt Energy, Crane Worldwide
...
| 항목 | 수치 | 비고 |
|------|------|------|
| 1세대 위성 | 648기 완료 | 5~7년 수명 교체 필요 |
| **Gen 2 추가 발주** | **Airbus 340기** (2026.01) | 기존 100기+340기=440기 |
| 투자 규모 | EU2~2.2B (2029까지) | ECA EU1B 파이낸싱 확보 |
| 인도 시작 | 2026말 | Toulouse 생산 |

- Gen 2 위성: 디지털 채널라이저, 온보드 프로세싱 기능 강화
- 유럽 정부/국방/통신사 대상 강점 (텔코 백홀)

### 4. 우주인터넷 (Direct-to-Cell)

#### 시장 개요
- **DTC 시장 규모 (2026E)**: $4.15B (CAGR 14.7%)
- **Satellite-to-Cell 시장 (2026E)**: $4.49B (2030년 $8.1B)
- **북미 점유율**: 39.8% | 아시아태평양: 26.5% (최고 성장률)

#### Starlink Mobile (구 Starlink Direct-to-Cell / T-Satellite)
- **DTC 위성 수**: 650기+
- **월 이용자**: 600만+ (22개국)
- **현재 서비스**: 텍스트 + 음성 + 데이터(Google Maps/WhatsApp 등 30개 앱)
- **요금**: $10/월 또는 프리미엄 플랜 포함
- **2026 목표**: 2,500만 이용자
- **V2 위성 (2027 중반)**: Starship 발사, 5G급, 6개월 내 1,200기 배치
- Deutsche Telekom 유럽 10개국 2028 계약
...
| 항목 | 수치 | 비고 |
|------|------|------|
| **Artemis II** | **4/1~4/11 성공 완료** | 50년 만에 최초 유인 달 비행 |
| 최대 거리 | 252,756마일 | 약 10일 미션 |
| 승무원 | Wiseman/Glover/Koch/Hansen | NASA 3명 + CSA 1명 |
| **Artemis III** | **2027 후반 (지연)** | **지구궤도 HLS 테스트 미션으로 변경** |
| **Artemis IV** | **2028** | **최초 달 착륙 (기존 III에서 변경)** |
| Artemis V | 2028 말 | 달 착륙 |

- **2/27 NASA장관 Isaacman 확인**: Artemis III를 지구궤도 랜더 도킹/체크아웃 미션으로 변경. SpaceX HLS + Blue Origin 랜더 테스트
- **SLS 코어스테이지 4/28 KSC 도착** -- Artemis III 조립 준비
- **CLPS 2.0** 이니셔티브 제안 (차세대 상업 달 배달 프로그램)
- 이후 매년 최소 1회 달 표면 착륙 계획
...
#### 차세대 발사체 (KSLV-III)
- **총 비용: 약 5조 6,230억원** (재사용형 포함)
- **2026년 예비설계 착수** (1,204억원 배정)
- 100톤급/10톤급 다단연소사이클 엔진 개발
- 한화에어로스페이스: 체계종합기업
- 2032년 완료 목표
...
| Golden Dome FY2026 | **$13.4B** | 방위 세출법안 포함 |
| **Golden Dome 포함 시** | **최대 $40B** | 미사일방어 위성 |
...
- **Astroscale ELSA-M**: 2026년 발사 예정 (520kg 서비서, OneWeb 위성 제거 시도)
  - ADR 다중물체 제거 특허 취득 (대형 비준비 물체 대상)
  - Isar Aerospace 발사 계약
- **ClearSpace PRELUDE**: 2026.01 발표, ESA 위탁 최초 ADR 핵심 기술 검증
- **UK CLEAR Phase 2 완료**: Astroscale+ClearSpace 2028 듀얼위성 디오빗 미션
- **OneWeb Gen 2** 440기 + Starlink 11,856기+ + Amazon 302기 = 궤도 혼잡 급속 심화
- ADR(Active Debris Removal) 시장 산업화 초기 단계
...
*이 파일은 knowledge-db/science_tech_2026.jsonl(subtag=space)에서 자동 생성됩니다.*
*HISTORY는 knowledge-db/에 영구 보관됩니다.*
*상호 참조: 과학기술 메타 -> industry/science_tech.md / AI -> industry/ai.md / 반도체 -> industry/semiconductor.md*
