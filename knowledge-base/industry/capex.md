...
> 갱신일: 2026-08-01 | 신뢰도: high | 유효: ~2026-08-31

---

## ★ 주간 델타 (8/1) — 직전 갱신(7/25) 이후 변화

- **[핵심] Q2 2026 하이퍼스케일러 어닝위크(7/29-31) 전부 확정 + capex 연쇄 상향**: **Microsoft FQ4(7/29)** 매출 $90B(+18%)·Azure +43%·Azure+클라우드 연매출 첫 $100B·Q4 capex 역대 $41B·Q1 FY27 capex >$50B → 낮은 Q4 capex+강한 Azure로 **주가 +3%**. **Meta(7/29)** 매출 $60.8B(+28%)·EPS $6.18(컨센 $7.22 대폭 하회)·**2026 capex $135-145B로 하단 +$10B 상향**·FCF $784M(-91%) → **주가 -8%**. **Amazon(7/31)** 매출 $200.6B(+20%)·**AWS +36.7%(18분기 최고, 컨센 31% 대폭 상회)**·**2026 현금 capex ~$220B로 상향**(기존 ~$200B). **Apple(7/30)** 매출 $109.4B(+16%)·시총 $5T 재탈환(capex 매출의 1.8%). **4사 합산 ~$750-765B(+77% YoY), top5(+Oracle) ~$825B** [CNBC, Investing.com, Seeking Alpha, valueaddvc]
- **[핵심] 메모리 Q2 어닝 확정 — 삼성·SK 역대급이나 SK 컨센 하회로 주가 급락**: **SK하이닉스 Q2(7/29)** 매출 79.3조(+256.8%)·**영업익 60.5조(+557%)·OPM 76%(+4%p QoQ)**·상반기 영업익 98조·매출 첫 100조 돌파(분기 사상 최대). 단 **시장 컨센(64조 안팎) 하회로 발표 후 주가 급락**. **삼성 DS(7/30)** 전사 영업익 89.5조(역대최대)·**DS 89.2조**·DX 0.8조 적자·**업계 최초 HBM4E 샘플 출하**. 양사 Q2 합산 OP ~150조 [SK하이닉스 뉴스룸, 삼성 뉴스룸, 헤럴드경제]
- **메모리 Q3-Q4 계약가 전망 이원화**: TrendForce Q3 DRAM +13-18% QoQ·NAND +10-15%로 **둔화**(소비자 수요 약화+높은 기저) vs **Jefferies Q3 DRAM +40-50%·Q4 +30-40% 강세**(2028 전까지 완화 없음). GS 삼성 DDR5 RDIMM Q3 $1,402(+13%). HBM4 +30%+ 프리미엄. DDR5 수익성이 HBM3e 초과 전망 [TrendForce, Jefferies, Goldman Sachs]
- **Vertiv Q2 확정(7/29) + FY 가이던스 상향**: 매출 $3.28B(컨센 $3.39B 하회)나 adj EPS $1.52(컨센 $1.43 상회, +60%)·adj OM 22.6%(+410bps). **FY2026 상향: 매출 $13.8-14.2B(중간 ~37% 성장)·adj EPS $6.65-6.75(~60% 성장)**, 백로그 $15B+ [StockTitan, Yahoo Finance]
- **Eaton Q2 확정(7/30) — 그리드투칩 슈퍼사이클**: 기록적 매출·유기성장 가이던스 재상향. **electrical 백로그 +48% YoY·주문 +47%**(Q1 DC주문 +240%). **solid-state 변압기(SST) 주문 H2 2026 개시·출하 late 2027**(중전압 DC 변환 신규 카테고리). 228GW DC 백로그 [Eaton IR, StockTitan]
- **한국 전력기기 3사 Q2 확정 — 슈퍼사이클 지속**: 3사 합산 매출 ~4.4조(+21.3%)·**영업익 7198억(+49.3%)**. **HD현대일렉트릭 Q2: 매출 1.14조·영업익 2870억(+37%)·수주잔고 $84.9억(+29.6% YoY)**, **Q2 빅테크 1.1조 전력기기 수주**(2027-2028 납품). LS일렉트릭 부산 초고압변압기 생산능력 3배 확대(2000억→6000억) [디지털데일리, 서울경제]
- **Stargate 확장 가속**: **OpenAI 조지아(Savannah) $30B+ DC — Georgia Power서 3.2GW 확보**(2028 가동 개시, OpenAI 최대급). **OpenAI-Oracle 추가 4.5GW Stargate 개발 합의($300B+ 5년 파트너십)**. 신규 5개 사이트+Abilene = ~7GW+/$400B+ 3년 [Bloomberg, OpenAI, Data Center Frontier]
- **파이낸싱 리스크 부상 — Moody's 경고 + 'SPV=서브프라임 CDO' 논쟁**: Moody's AI 부채 급증 경고. 오프밸런스시트 SPV $120B+ 지속. **'AI DC SPV가 서브프라임 모기지 CDO와 구조적 유사'** 유비 확산. **CoreWeave $8.5B DDTL 4.0**(Meta 계약+GPU 담보, SPV 'CoreWeave Compute Acquisition Co VIII')= 첫 GPU담보 IG등급 파이낸싱. Oracle $14B+ DC부채 2차시장 리프라이싱·PIMCO 매도 지속 [Cryptopolitan, Longbridge, Moody's]
---
...
- **OpenAI Stargate (8/1 갱신)**: ~**9-10GW** AI 인프라 목표($500B). **[7월 신규] OpenAI 조지아(Savannah 인근 Effingham) $30B+ DC — Georgia Power서 3.2GW 확보**(수백MW 2028 가동·2032까지 확장, OpenAI 최대급). **OpenAI-Oracle 추가 4.5GW Stargate 개발 합의($300B+ 5년 파트너십)**. 신규 5개 사이트+Abilene+CoreWeave = ~7GW+ 계획·$400B+ 3년 투자. **Abilene(TX) 플래그십 8개동 중 ~4개동 건설(NVIDIA Blackwell 탑재)이나 6월 기준 여전히 미가동**(Crusoe 초기 2동 신기록 후 후속 지연). **당초 2.1GW 확장 계획 철회 — 해당 용량 타 사이트로 재배분**. Stargate 자체발전 6.8GW 건설 중. 온사이트 천연가스+그리드+풍력 혼합 전력. 경쟁사 대비 비용·일정 초과 [distilled.earth, Epoch AI, Data Center Frontier]
...
8. 한국 전력기기: 효성중공업, HD현대일렉트릭, LS일렉트릭
   -> 빅3 수주잔고 32.5조(연내 40조 전망). 3사 Q2 합산 영업익 7198억(+49.3%). HD현대 Q2 영업익 2870억·수주잔고 $84.9억·빅테크 1.1조 추가 수주. LS 부산 초고압변압기 생산능력 3배. 미국 현지 증설(앨라배마/유타/멤피스)
