...
> 갱신일: 2026-07-18 | 신뢰도: high | 유효: ~2026-08-17

---

## ★ 주간 델타 (7/18) — 직전 갱신(7/11) 이후 변화

- **[핵심] TSMC Q2 2026 확정(7/16)**: 매출 **$40.20B(+33.7% YoY**, 가이던스 상단), GM **67.7%(역대최고)**, 순이익 **+77.4% YoY(역대최고)**. HPC +20% QoQ·매출 비중 **66%**. **2026 capex $52-56B → $60-64B 대폭 상향**(첨단공정 70-80%). FY 매출성장 가이던스 'close to 30%' → **'slightly above 40%'** 상향. AI 가속기·에이전트AI CPU 수요 견인 [Tom's Hardware, Investing.com, TradingKey, BigGo]
- **[핵심] TSMC Arizona 추가 $100B → 총 $265B(7/16)**: 기존 $165B에서 확대. 신규 2nm+ 첨단 팹 4개 추가 → 전체 계획 **10팹 + 2 어드밴스드패키징 + R&D 센터**. CoWoS 패키징 병목 대응. 미국 첨단칩 현지생산 가속 [betanews, EETimes, American Bazaar]
- **HBM4 가격/DDR5 마진(7/12)**: HBM4 ~$500/스택, 2027 **$4-5/Gb로 2배+ 전망**. UBS — NVIDIA Rubin용 HBM4 SK하이닉스 **~70% 점유** 전망. 삼성 2026 HBM capacity +50%. **SK하이닉스 DDR5 OP마진 ~90% 육박** — HBM4 램프 의도적 감속하고 커모디티 DDR5 고마진 포착. SK 1c노드 월 20K→160-190K 웨이퍼(연말) [Seoul Economic Daily, Silicon Analysts, UBS]
- **GE Vernova Q2 프리뷰(7/22-23)**: Q2 가스파워 장비주문 가이던스 **10-15GW**. 연말 백로그+슬롯 100→**110GW+** 목표. Q1 총주문 $18.3B(+71% 유기). Polymarket Q2 주문 $18B+ 85.5% 확률. 'AI 파워스택 전 계층 판매 유일 미국 상장사' [247WallSt, Utility Dive]
- **한국 전력기기 신규 수주(7월)**: **LS일렉트릭 AWS 1700억원대 배전반 + 2분기 5건 연속 수주·세계 첫 DC 전용공장 가동**. HD현대일렉트릭 북미 빅테크 1.12조원(2028까지). 효성중공업 호주 AusNet 3100억원. 3사 5년치 일감에도 신규 지속. 미국 변압기 3-4년·차단기 조달난이 DC 건설 핵심변수 [인베스트조선, 브릿지경제, 비즈니스포스트]
- **하이퍼스케일러 Q2 어닝 임박**: 4사 2026 capex 컨센 **$725B** 유지(Amazon $200B·Alphabet $175-190B·Meta $125-145B·Microsoft $190B). MSFT/GOOGL/META/AMZN Q2 실적 7월말~8월초 개시 → 부품비發 추가 상향 촉각. 2027 $1T+ 전망 [Tom's Hardware, Futurum, Investing.com]
- **변압기/스위치기어 공급부족 지속**: 스위치기어 **2028까지 완판**, 대형변압기 3-5년(128주)·GSU 144주. 2026 미국 DC 30-50% 지연/취소. 2028 이후에나 지역별 완화 [PowerMag, Build.inc, Energy News Beat]
...
| **GE Vernova (GEV)**   | **Q1 2026 매출 $9.34B(+16.3%), 총주문 $18.3B(+71% 유기)**, **백로그 $116B→$163B**(전분기 +$13B+) | **FY2026 가이던스 상향: 매출 $44.5-45.5B, FCF $6.5-7.5B**. Electrification 주문 $7.1B(+86% 유기, book-to-bill ~2.5). DC 전기장비 주문 Q1 $2.4B(2025 연간 전체 초과). **가스터빈 백로그 Q1 100GW(+17GW), 2026말 백로그+슬롯 110GW+ 목표. 2030-31 완전 완판**. H1 2026 신규 kW당 가격 Q4 2025 대비 +10~20%p. AI/DC가 가스터빈 백로그 ~20%. **Q2 실적 7/22-23: 가스파워 장비주문 가이던스 10-15GW(Polymarket $18B+ 85.5% 확률)** | AI 전력 트레이드 핵심 수혜주. 전력기기·그리드 [GE Vernova IR, Power-Eng, Utility Dive]                                       |
...
- **스위치기어 2028까지 완판 (7/18 재확인)**: 데이터센터용 스위치기어(switchgear)가 사실상 **2028년까지 완판**. 대형 전력변압기 3-5년(평균 128주)·GSU 144주 납기 지속으로 2026 계획 미국 DC의 30-50%가 지연/취소 리스크. 병목은 숙련인력·특수강·테스트베이 → 2028 이후에나 지역별 완화. **GE Vernova Q2 실적 7/22-23(가스파워 주문 10-15GW 가이던스)** [Sandstone Group, PowerMag, Build.inc, Energy News Beat]
