...
│
├── (브리핑 5개, v3.0 신규 — briefing-lead/global-macro-analyst는 Opus, 나머지 3개는 Sonnet)
...
> ⭐ = v3.0 신규. briefing-lead·global-macro-analyst는 Opus, market-data-collector·correlation-monitor·briefing-report-generator는 **Sonnet으로 변경 (2026-04-09)**.
