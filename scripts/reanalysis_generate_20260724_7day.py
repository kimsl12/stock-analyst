"""
재분석 자동 실행 — 2026-07-24 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (10일 코호트 = 2026-07-14 분석분, 오늘 01:00 10일 슬롯이 처리 못 한 백로그):
  HOOD v10, INTC v10, LUNR v10, META v11, IONQ v10,
  LVMUY v11, MA v10, LLY v11, MRK v10, IBM v9
- 오늘 01:00 10일 슬롯(staock_update)이 SNDK/T/MUU/NVO/MS/NVS/MU/PG/SOXL/SOXS 10종 처리.
...
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-07-23)
...
TODAY = "2026-07-24"
YYYYMMDD = "20260724"
RUN_MD = "20260724b_run"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "HOOD":  ("Robinhood",         "로빈후드",           10, "2026-07-14"),
    "INTC":  ("Intel",             "인텔",               10, "2026-07-14"),
    "LUNR":  ("IntuitiveMachines", "인튜이티브머신스",   10, "2026-07-14"),
    "META":  ("Meta",              "메타플랫폼스",       11, "2026-07-14"),
    "IONQ":  ("IonQ",              "아이온큐",           10, "2026-07-14"),
    "LVMUY": ("LVMH",              "루이비통모엣헤네시", 11, "2026-07-14"),
    "MA":    ("Mastercard",        "마스터카드",         10, "2026-07-14"),
    "LLY":   ("EliLilly",          "일라이릴리",         11, "2026-07-14"),
    "MRK":   ("Merck",             "머크",               10, "2026-07-14"),
    "IBM":   ("IBM",               "IBM",                9,  "2026-07-14"),
}
