#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-07-24 7일 회차) — consensus/risks/scorecard/fragile/confidence 표준화. 멱등."""
import json, os

PLAN = {
    "HOOD": "Robinhood_v10", "INTC": "Intel_v10", "LUNR": "IntuitiveMachines_v10",
    "META": "Meta_v11", "IONQ": "IonQ_v10", "LVMUY": "LVMH_v11",
    "MA": "Mastercard_v10", "LLY": "EliLilly_v11", "MRK": "Merck_v10", "IBM": "IBM_v9",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
