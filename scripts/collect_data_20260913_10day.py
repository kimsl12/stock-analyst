#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""재분석 데이터 수집 — 2026-09-12 (10일 임계, staock_update 슬롯, /재분석실행 10 10).
검출: timeline.json max-v date 기준 10일+ 경과 (진실 소스).
  09-02 배치(10일, v14/v15) + ANTHROPIC(비상장·비표준 108일, standing 제외).
상한 10종 — 09-02 배치 10종 전부 (10일 경과, cap 10과 일치).
대상 10종: PLTR PG NVS NVO MRK META MA LVMUY LUNR LLY (전부 미국 상장, 한국 .KS 없음).
yfinance 단일계열(WebSearch 미바인딩)로 리치 data.json 생성. 09-11 스크립트 재사용."""
...
PLAN = {
    "NEE":  ("NextEraEnergy",      "넥스트에라에너지",   10,  9, "2026-09-03"),
    "SO":   ("SouthernCompany",    "서던컴퍼니",         10,  9, "2026-09-03"),
    "MU":   ("Micron",             "마이크론",           15, 14, "2026-09-03"),
    "MUU":  ("DirexionDailyMU2X",  "디렉시온MU2X",       12, 11, "2026-09-03"),
    "NKE":  ("Nike",               "나이키",             15, 14, "2026-09-03"),
    "TM":   ("Toyota",             "토요타",             14, 13, "2026-09-03"),
    "OKLO": ("Oklo",               "오클로",              9,  8, "2026-09-03"),
    "VNQ":  ("VanguardRealEstate", "뱅가드부동산ETF",     9,  8, "2026-09-03"),
    "O":    ("RealtyIncome",       "리얼티인컴",          9,  8, "2026-09-03"),
    "SPY":  ("SPDR_SP500",         "SPDR S&P500 ETF",    15, 14, "2026-09-03"),
}
