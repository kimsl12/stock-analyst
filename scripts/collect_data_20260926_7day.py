...
대상 10종: 005930 삼성전자·207940 삼성바이오·329180 HD현대重·AAPL·ABBV·AMD·AMZN·C·CAT·HOOD (KR 3종 포함).
yfinance 단일계열(WebSearch 미바인딩)로 리치 data.json 생성. 09-25 10day 스크립트 재사용.
KR ATR nan 방어: history dropna(High/Low/Close). 배당수익률 스케일 함정(저배당 KR ×100) 사후 divY>5% 대조 필수."""
...
PLAN = {
    "005930": ("삼성전자",        "삼성전자",         17, 16, "2026-09-17"),
    "207940": ("삼성바이오로직스",  "삼성바이오로직스",   10,  9, "2026-09-17"),
    "329180": ("HD현대중공업",     "HD현대중공업",      18, 17, "2026-09-17"),
    "AAPL":   ("Apple",          "애플",             10,  9, "2026-09-17"),
    "ABBV":   ("AbbVie",         "애브비",            16, 15, "2026-09-17"),
    "AMD":    ("AMD",            "AMD",              10,  9, "2026-09-17"),
    "AMZN":   ("Amazon",         "아마존",            17, 16, "2026-09-17"),
    "C":      ("Citigroup",      "씨티그룹",          17, 16, "2026-09-17"),
    "CAT":    ("Caterpillar",    "캐터필러",          17, 16, "2026-09-17"),
    "HOOD":   ("Robinhood",      "로빈후드",          17, 16, "2026-09-17"),
}
