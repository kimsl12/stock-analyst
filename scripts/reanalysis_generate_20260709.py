#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-09 (10일 임계, 상한 10, staock_update 슬롯)
대상 10종 (10~11일 stale, 06-28/29 배치):
...
- 가격: analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-07-08)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260709_run.md (메인이 별도 작성)
...
PLAN = {
    "LRCX": ("LamResearch",        "램리서치",       7, "2026-06-28"),
    "KO":   ("CocaCola",           "코카콜라",       8, "2026-06-28"),
    "JPM":  ("JPMorgan",           "JP모건",         7, "2026-06-28"),
    "IWM":  ("iSharesRussell2000", "iShares 러셀2000", 9, "2026-06-28"),
    "GEV":  ("GEVernova",          "GE버노바",       7, "2026-06-28"),
    "STX":  ("Seagate",            "시게이트",       9, "2026-06-29"),
    "SMR":  ("NuScalePower",       "뉴스케일파워",   7, "2026-06-29"),
    "SLV":  ("iSharesSilver",      "iShares 실버",   8, "2026-06-29"),
    "RKLB": ("RocketLab",          "로켓랩",         8, "2026-06-29"),
    "QQQ":  ("InvescoQQQ",         "인베스코 QQQ",   8, "2026-06-29"),
}
