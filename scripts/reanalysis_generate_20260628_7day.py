#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-28 (7일 임계, 상한 10, stock_update-2 슬롯)
대상 10종: 009150 삼성전기 v7, 329180 HD현대중공업 v8, 466100 클로봇 v7, ADBE v8, ANET v6,
...
- 회차 보고: analysis/_reanalysis_runs/20260628_run_7day.md (메인이 별도 작성)
"""
import json, os, sys
