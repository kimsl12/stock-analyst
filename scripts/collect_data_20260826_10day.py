#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""재분석 데이터 수집 — 2026-08-26 (10일 임계, staock_update 슬롯, /재분석실행 10 10).
검출: timeline.json max-v date 기준 20종이 10일+ 경과(08-16 코호트). ANTHROPIC(비상장·비표준, 91일) standing 제외.
7일런(stock_update-2, cap 10/일)이 146종 유니버스를 10일 내로 다 못 덮어 오버플로가 정확히 10일에 새어나온 코호트.
알파벳 정렬 상위 10종.
...
로직은 20260825b 검증본 재사용, PLAN 만 08-16 코호트 알파벳 상위 10종으로 교체.
"""
...
PLAN = {
    "000720": ("현대건설",                       "현대건설",             7,  6,  "2026-08-16"),
    "052690": ("한전기술",                       "한전기술",             7,  6,  "2026-08-16"),
    "JEPI":   ("JPMorganEquityPremiumIncome",   "JEPI",                7,  6,  "2026-08-16"),
    "LQD":    ("iSharesInvestmentGradeCorpBond","LQD",                 7,  6,  "2026-08-16"),
    "MLM":    ("MartinMarietta",                "마틴마리에타",         8,  7,  "2026-08-16"),
    "MUFG":   ("Mitsubishi",                    "미쓰비시UFJ",          14, 13, "2026-08-16"),
    "NEE":    ("NextEraEnergy",                 "넥스트에라에너지",     8,  7,  "2026-08-16"),
    "NKE":    ("Nike",                          "나이키",               13, 12, "2026-08-16"),
    "O":      ("RealtyIncome",                  "리얼티인컴",           7,  6,  "2026-08-16"),
    "OKLO":   ("Oklo",                          "오클로",               7,  6,  "2026-08-16"),
}
