#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-08-09 7일 회차, /재분석실행 7 20→cap10, stock_update-2) — 멱등.
consensus/risks/scorecard/fragile/confidence 표준화 + 필수 키 보증 (generator KeyError 방지)."""
import json, os

PLAN = {
    "010120": "LSELECTRIC_v13", "012450": "한화에어로스페이스_v12",
    "034020": "두산에너빌리티_v12", "035720": "카카오_v12",
    "AGG": "iSharesCoreUSAggregateBond_v11", "AMAT": "AppliedMaterials_v13",
    "ASTS": "ASTSpaceMobile_v12", "AVGO": "Broadcom_v13",
    "BAC": "BankOfAmerica_v12", "BRKB": "BerkshireHathaway_v12",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
