"""재분석 자동 실행 — 2026-08-01 (10일 임계, 상한 10, staock_update 슬롯, /재분석실행 10 10)
대상 10종 (07-18 코호트 5종 + 07-20 코호트 5종):
  VIG v9, TLT v11, VRT v9, XOM v11, VST v9, TMO v4, QCOM v4, NOW v4, NFLX v4, MELI v4
- ANTHROPIC 비상장·비표준 standing 제외. 크립토(QuantTrader 별도) 제외.
- BLIND: 분석가가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-07-31)
...
PLAN = {
    "VIG":  ("VanguardDividendAppreciation", "뱅가드배당성장ETF", 9,  "2026-07-18"),
    "TLT":  ("iSharesTreasury",              "아이셰어스20년국채", 11, "2026-07-18"),
    "VRT":  ("VertivHoldings",               "버티브홀딩스",       9,  "2026-07-18"),
    "XOM":  ("ExxonMobil",                   "엑슨모빌",           11, "2026-07-18"),
    "VST":  ("VistraCorp",                   "비스트라",           9,  "2026-07-18"),
    "TMO":  ("ThermoFisher",                 "써모피셔사이언티픽", 4,  "2026-07-20"),
    "QCOM": ("Qualcomm",                     "퀄컴",               4,  "2026-07-20"),
    "NOW":  ("ServiceNow",                   "서비스나우",         4,  "2026-07-20"),
    "NFLX": ("Netflix",                      "넷플릭스",           4,  "2026-07-20"),
    "MELI": ("MercadoLibre",                 "메르카도리브레",     4,  "2026-07-20"),
}
