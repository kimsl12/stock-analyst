"""
재분석 자동 실행 — 2026-07-25 (10일 임계, 상한 10, staock_update 슬롯, /재분석실행 10 10)
대상 6종 (10일 코호트 = 2026-07-15 분석분, 7일 런 일일 cap 으로 새어나온 백로그):
  052690 v4(한전기술), BWXT v5, DUK v5, LQD v4(ETF), MLSS v10, PLTR v11
- ANTHROPIC 비상장·비표준 standing 제외 (59일 경과이나 시장데이터 재분석 불가). 크립토(QuantTrader 별도) 제외.
- BLIND: 분석가가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-07-24; 052690 은 2026-07-23 폴백)
...
PLAN = {
    "052690": ("한전기술",                       "한전기술(KEPCO E&C)",         4,  "2026-07-15"),
    "BWXT":   ("BWXTechnologies",               "BWX테크놀로지스",             5,  "2026-07-15"),
    "DUK":    ("DukeEnergy",                    "듀크에너지",                  5,  "2026-07-15"),
    "LQD":    ("iSharesInvestmentGradeCorpBond", "iShares 투자등급 회사채 ETF", 4,  "2026-07-15"),
    "MLSS":   ("MilestoneScientific",           "마일스톤사이언티픽",          10, "2026-07-15"),
    "PLTR":   ("Palantir",                      "팔란티어",                    11, "2026-07-15"),
}
