#!/usr/bin/env python3
"""_content.json 스키마 정규화 — 2026-08-26 10일 회차(staock_update, /재분석실행 10 10) — 멱등.
...
PLAN = {
    "000720": "현대건설_v7", "052690": "한전기술_v7",
    "JEPI": "JPMorganEquityPremiumIncome_v7", "LQD": "iSharesInvestmentGradeCorpBond_v7",
    "MLM": "MartinMarietta_v8", "MUFG": "Mitsubishi_v14", "NEE": "NextEraEnergy_v8",
    "NKE": "Nike_v13", "O": "RealtyIncome_v7", "OKLO": "Oklo_v7",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
