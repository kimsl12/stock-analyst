#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-04 (회차 1, 7일 임계) — 10종 BLIND 일괄 생성
대상: TQQQ v5, SHEL v5, IONQ v4, TMUS v5, MUFG v5, LRCX v3, JPM v3, SPY v4, MLSS v4, HOOD v4
...
PLAN = {
    "TQQQ": ("ProSharesUltraProQQQ", "ProShares 울트라프로 QQQ (3X)", 5, "2026-05-25"),
    "SHEL": ("Shell", "셸", 5, "2026-05-25"),
    "IONQ": ("IonQ", "아이온큐", 4, "2026-05-25"),
    "TMUS": ("TMobile", "T-모바일", 5, "2026-05-25"),
    "MUFG": ("Mitsubishi", "미쓰비시 UFJ", 5, "2026-05-25"),
    "LRCX": ("LamResearch", "램리서치", 3, "2026-05-25"),
    "JPM":  ("JPMorgan", "JP모건", 3, "2026-05-25"),
    "SPY":  ("SPDR_SP500", "SPDR S&P500 ETF", 4, "2026-05-25"),
    "MLSS": ("MilestoneScientific", "마일스톤 사이언티픽", 4, "2026-05-26"),
    "HOOD": ("Robinhood", "로빈후드", 4, "2026-05-26"),
}
