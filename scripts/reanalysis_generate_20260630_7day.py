#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-30 (7일 임계, 상한 10, stock_update-2 슬롯)
대상 10종: SMR v6, PM v8, PWR v6, RKLB v7, QLD v6, QQQ v7, NVDA v8, SLV v7, CEG v6, STX v8
- BLIND 모드: 이전 v{N-1} 절대 read 안 함 (general-purpose 에이전트가 _content.json 작성)
- 가격은 analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-06-29)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260630_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-06-30"
YYYYMMDD = "20260630"
RUN_MD = "20260630_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "SMR":  ("NuScalePower",        "뉴스케일파워",          6, "2026-06-21"),
    "PM":   ("PhilipMorris",        "필립모리스",            8, "2026-06-21"),
    "PWR":  ("QuantaServices",      "콴타서비스",            6, "2026-06-21"),
    "RKLB": ("RocketLab",           "로켓랩",                7, "2026-06-21"),
    "QLD":  ("ProSharesUltraQQQ",   "프로셰어즈 울트라 QQQ", 6, "2026-06-21"),
    "QQQ":  ("InvescoQQQ",          "인베스코 QQQ",          7, "2026-06-21"),
    "NVDA": ("NVIDIA",              "엔비디아",              8, "2026-06-21"),
    "SLV":  ("iSharesSilver",       "iShares 실버 트러스트", 7, "2026-06-21"),
    "CEG":  ("ConstellationEnergy", "콘스텔레이션에너지",    6, "2026-06-21"),
    "STX":  ("Seagate",             "시게이트",              8, "2026-06-21"),
}
