#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-05 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (9일 stale, 06-26 배치):
  LLY v9, LVMUY v9, MA v8, META v9, MRK v8, MU v8, MUU v5, NVO v8, ORCL v7, PEP v8
...
- 회차 보고: analysis/_reanalysis_runs/20260705_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-07-05"
YYYYMMDD = "20260705"
RUN_MD = "20260705_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "LLY":   ("EliLilly",          "일라이릴리",   9, "2026-06-26"),
    "LVMUY": ("LVMH",              "LVMH",         9, "2026-06-26"),
    "MA":    ("Mastercard",        "마스터카드",   8, "2026-06-26"),
    "META":  ("Meta",              "메타플랫폼스", 9, "2026-06-26"),
    "MRK":   ("Merck",             "머크",         8, "2026-06-26"),
    "MU":    ("Micron",            "마이크론",     8, "2026-06-26"),
    "MUU":   ("DirexionDailyMU2X", "디렉시온 마이크론 2배 레버리지 ETF", 5, "2026-06-26"),
    "NVO":   ("NovoNordisk",       "노보노디스크", 8, "2026-06-26"),
    "ORCL":  ("Oracle",            "오라클",       7, "2026-06-26"),
    "PEP":   ("PepsiCo",           "펩시코",       8, "2026-06-26"),
}
