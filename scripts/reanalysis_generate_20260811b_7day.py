"""재분석 자동 실행 — 2026-08-11 (7일 임계, 상한 10, stock_update-2 슬롯, /재분석실행 7 20→cap10)
08-02 코호트 상장 10종(정확히 9일 경과). ANTHROPIC(76일) 비상장·비표준 standing 제외.
당일 10일 런(staock_update)이 08-01 코호트 10종 선처리 → 본 b회차는 08-02 코호트 10종.
- BLIND: 분석가(Agent 10종 병렬)가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-08-10)
...
TODAY = "2026-08-11"
YYYYMMDD = "20260811"
RUN_MD = "20260811b_run"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "005380": ("현대차",            "현대차",           5,  "2026-08-02"),
    "005930": ("삼성전자",          "삼성전자",         12, "2026-08-02"),
    "009150": ("삼성전기",          "삼성전기",         12, "2026-08-02"),
    "207940": ("삼성바이오로직스",  "삼성바이오로직스", 5,  "2026-08-02"),
    "329180": ("HD현대중공업",      "HD현대중공업",     13, "2026-08-02"),
    "AAPL":   ("Apple",             "애플",             5,  "2026-08-02"),
    "ABBV":   ("AbbVie",            "애브비",           11, "2026-08-02"),
    "ADBE":   ("Adobe",             "어도비",           13, "2026-08-02"),
    "AMD":    ("AMD",               "AMD",              5,  "2026-08-02"),
    "ANET":   ("AristaNetworks",    "아리스타네트웍스", 11, "2026-08-02"),
}
