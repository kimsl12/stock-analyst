#!/usr/bin/env python3
"""_content.json 스키마 정규화 — 2026-08-27 10일 회차(staock_update, /재분석실행 10 10) — 멱등.
...
PLAN = {
    "010120": "LSELECTRIC_v15", "012450": "한화에어로스페이스_v14",
    "034020": "두산에너빌리티_v14", "035720": "카카오_v14",
    "AGG": "iSharesCoreUSAggregateBond_v13", "AMAT": "AppliedMaterials_v15",
    "ASML": "ASML_v14", "ASTS": "ASTSpaceMobile_v14",
    "AVGO": "Broadcom_v15", "AZN": "AstraZeneca_v14",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
