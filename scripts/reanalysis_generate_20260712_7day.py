#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-12 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (9~10일 stale, 07-02/03 배치):
  UNP v9, USMV v9(ETF), UNH v2, TMO v2, SPGI v2, QCOM v2, NOW v2, NFLX v2, MELI v2, LNG v2
- BLIND: general-purpose 에이전트가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-07-10)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260712_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-07-12"
YYYYMMDD = "20260712"
RUN_MD = "20260712_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "UNP":  ("UnionPacific",   "유니온퍼시픽",             9, "2026-07-02"),
    "USMV": ("iSharesMinVol",  "iShares 미국 최소변동성", 9, "2026-07-03"),
    "UNH":  ("UnitedHealth",   "유나이티드헬스",           2, "2026-07-03"),
    "TMO":  ("ThermoFisher",   "써모피셔사이언티픽",       2, "2026-07-03"),
    "SPGI": ("SPGlobal",       "S&P글로벌",                2, "2026-07-03"),
    "QCOM": ("Qualcomm",       "퀄컴",                     2, "2026-07-03"),
    "NOW":  ("ServiceNow",     "서비스나우",               2, "2026-07-03"),
    "NFLX": ("Netflix",        "넷플릭스",                 2, "2026-07-03"),
    "MELI": ("MercadoLibre",   "메르카도리브레",           2, "2026-07-03"),
    "LNG":  ("CheniereEnergy", "셰니에르에너지",           2, "2026-07-03"),
}
