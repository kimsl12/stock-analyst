#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-06 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (8~9일 stale, 06-27/28 배치):
...
- 가격: analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-07-02/03)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260706_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-07-06"
YYYYMMDD = "20260706"
RUN_MD = "20260706_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "COST":   ("Costco",         "코스트코",       9, "2026-06-27"),
    "COIN":   ("Coinbase",       "코인베이스",     9, "2026-06-27"),
    "BHP":    ("BHPGroup",       "BHP그룹",        9, "2026-06-27"),
    "ADBE":   ("Adobe",          "어도비",         9, "2026-06-27"),
    "329180": ("HD현대중공업",   "HD현대중공업",   9, "2026-06-27"),
    "466100": ("클로봇",         "클로봇",         8, "2026-06-27"),
    "009150": ("삼성전기",       "삼성전기",       8, "2026-06-27"),
    "ANET":   ("AristaNetworks", "아리스타네트웍스", 7, "2026-06-27"),
    "CVX":    ("Chevron",        "셰브론",         9, "2026-06-28"),
    "005930": ("삼성전자",       "삼성전자",       8, "2026-06-28"),
}
