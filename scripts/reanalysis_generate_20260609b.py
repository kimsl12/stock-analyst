#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-09 회차2 (7일 임계, 상한 10) — 10종 BLIND 일괄 생성
...
- 회차 보고: analysis/_reanalysis_runs/20260609_run2.md
"""
import json, os, sys
...
TODAY = "2026-06-09"
YYYYMMDD = "20260609"
RUN_MD = "20260609_run2"

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "ORCL":   ("Oracle",                     "오라클",                 4, "2026-05-31"),
    "012450": ("한화에어로스페이스",            "한화에어로스페이스",      5, "2026-06-01"),
    "ABBV":   ("AbbVie",                     "애브비",                 4, "2026-06-01"),
    "AGG":    ("iSharesCoreUSAggregateBond", "iShares 미국종합채권 ETF", 4, "2026-06-01"),
    "AMAT":   ("AppliedMaterials",           "어플라이드 머티어리얼즈",  6, "2026-06-01"),
    "AMZN":   ("Amazon",                     "아마존",                 5, "2026-06-01"),
    "ASTS":   ("ASTSpaceMobile",             "AST 스페이스모바일",      5, "2026-06-01"),
    "AVGO":   ("Broadcom",                   "브로드컴",               6, "2026-06-01"),
    "BLK":    ("BlackRock",                  "블랙록",                 5, "2026-06-01"),
    "GOOGL":  ("Alphabet",                   "알파벳",                 5, "2026-06-01"),
}
        ...
        "custom_sections": [
            ...
            },
            {
                ...
                "content": (
                    ...
                    f"- **임계 경과**: 7~9일 (7일 임계, 상한 10종, 2026-06-09 회차2)\n"
...
def main():
    ...
    print(f"=== 재분석 자동 실행 — {TODAY} 회차2 (7일 임계) BLIND — {len(only)}종 ===\n")
    ok, fail = [], []
    for ticker in only:
