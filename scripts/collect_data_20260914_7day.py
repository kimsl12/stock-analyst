#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""재분석 데이터 수집 — 2026-09-14 (7일 임계, stock_update-2 슬롯, /재분석실행 7 20→cap10).
검출: timeline.json max-v date 기준 7일+ 경과 (진실 소스).
  가장 오래된 09-05 배치(20종, 9일) 중 b-코호트(7일 슬롯 원 코호트) 10종. ANTHROPIC(비상장·비표준, standing 제외).
대상 10종: SOXX SLV SHEL SAP RKLB PWR NVDA LRCX KO JPM (전부 미국 상장).
yfinance 단일계열(WebSearch 미바인딩)로 리치 data.json 생성. 09-13 스크립트 재사용."""
...
PLAN = {
    "SOXX": ("iSharesSemiconductor", "iShares 반도체 ETF",  13, 12, "2026-09-05"),
    "SLV":  ("iSharesSilver",        "iShares 실버 트러스트", 15, 14, "2026-09-05"),
    "SHEL": ("Shell",                "셸",                  16, 15, "2026-09-05"),
    "SAP":  ("SAP",                  "SAP",                 15, 14, "2026-09-05"),
    "RKLB": ("RocketLab",            "로켓랩",              15, 14, "2026-09-05"),
    "PWR":  ("QuantaServices",       "콴타서비시스",         14, 13, "2026-09-05"),
    "NVDA": ("NVIDIA",               "엔비디아",            16, 15, "2026-09-05"),
    "LRCX": ("LamResearch",          "램리서치",            14, 13, "2026-09-05"),
    "KO":   ("CocaCola",             "코카콜라",            15, 14, "2026-09-05"),
    "JPM":  ("JPMorgan",             "JP모건체이스",         14, 13, "2026-09-05"),
}
