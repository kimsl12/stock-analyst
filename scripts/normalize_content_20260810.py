#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-08-10 10일 회차, /재분석실행 10 10, staock_update 슬롯) — 멱등.
consensus/risks/scorecard/fragile/confidence 표준화 + 필수 키 보증 (generator KeyError 방지)."""
import json, os

PLAN = {
    "WMT": "Walmart_v12", "V": "Visa_v12", "VZ": "Verizon_v12",
    "TSLA": "Tesla_v12", "TIP": "iSharesTIPS_v12", "STX": "Seagate_v12",
    "SMR": "NuScalePower_v10", "DIS": "Disney_v12", "C": "Citigroup_v12",
    "CAT": "Caterpillar_v12",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
