#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-15 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (9일 stale, 2026-07-06 코호트):
  HOOD v9, INTC v9, SOXS v9(ETF3x), NVS v10, LUNR v9, SOXL v9(ETF3x),
  MS v10, IONQ v9, SNDK v11, IBM v8
- BLIND: general-purpose 에이전트가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-07-14)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260715_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-07-15"
YYYYMMDD = "20260715"
RUN_MD = "20260715_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "HOOD": ("Robinhood",              "로빈후드",              9,  "2026-07-06"),
    "INTC": ("Intel",                  "인텔",                  9,  "2026-07-06"),
    "SOXS": ("Direxion3xSemiBear",     "디렉시온 반도체 3배 베어", 9,  "2026-07-06"),
    "NVS":  ("Novartis",               "노바티스",              10, "2026-07-06"),
    "LUNR": ("IntuitiveMachines",      "인튜이티브머신스",      9,  "2026-07-06"),
    "SOXL": ("Direxion3xSemiconductor", "디렉시온 반도체 3배 불", 9,  "2026-07-06"),
    "MS":   ("MorganStanley",          "모건스탠리",            10, "2026-07-06"),
    "IONQ": ("IonQ",                   "아이온큐",              9,  "2026-07-06"),
    "SNDK": ("Sandisk",                "샌디스크",              11, "2026-07-06"),
    "IBM":  ("IBM",                    "IBM",                   8,  "2026-07-06"),
}
