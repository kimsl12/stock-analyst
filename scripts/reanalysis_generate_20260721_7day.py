#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-21 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (경과일 desc, 동률 티커 desc, ANTHROPIC 비상장 standing 제외):
  8일(2026-07-13 코호트): PEP v10, ORCL v9, LIN v3, JNJ v10, ISRG v3, HSBC v10, HD v10, GS v11, GOOGL v10, GLD v10(ETF)
- BLIND: general-purpose 에이전트가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-07-20)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260721b_run.md (메인이 별도 작성)
...
TODAY = "2026-07-21"
YYYYMMDD = "20260721"
RUN_MD = "20260721b_run"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "PEP":   ("PepsiCo",           "펩시코",           10, "2026-07-13"),
    "ORCL":  ("Oracle",            "오라클",           9,  "2026-07-13"),
    "LIN":   ("Linde",             "린데",             3,  "2026-07-13"),
    "JNJ":   ("JohnsonJohnson",    "존슨앤드존슨",     10, "2026-07-13"),
    "ISRG":  ("IntuitiveSurgical", "인튜이티브서지컬", 3,  "2026-07-13"),
    "HSBC":  ("HSBC",              "HSBC",             10, "2026-07-13"),
    "HD":    ("HomeDepot",         "홈디포",           10, "2026-07-13"),
    "GS":    ("GoldmanSachs",      "골드만삭스",       11, "2026-07-13"),
    "GOOGL": ("Alphabet",          "알파벳",           10, "2026-07-13"),
    "GLD":   ("SPDRGoldShares",    "SPDR 골드 셰어즈", 10, "2026-07-13"),
}
