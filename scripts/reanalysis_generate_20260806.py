"""재분석 자동 실행 — 2026-08-06 (10일 임계, 상한 10, staock_update 슬롯, /재분석실행 10 10)
07-25 코호트 개별주 10종(12일 경과). SSD 언마운트 장애(07-26~29)+이후 공백으로 백로그 누적,
07-25 분석분이 12일까지 경과 → 본 10일 임계 런이 정상 흡수. ANTHROPIC 비상장·비표준 standing 제외.
동일 12일 경과 16종 중 개별 기업 10종 우선(재분석 정보가치 우위), 광범위 지수 ETF 6종은 차기 회차:
  TSM v11, TXN v11, TTE v11, TMUS v12, TM v10, CEG v10, CCJ v6, 052690 v5, 035420 v12, 000720 v5
- BLIND: 분석가가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-08-05)
...
PLAN = {
    "TSM":    ("TSMC",                "TSMC",              11, "2026-07-25"),
    "TXN":    ("TexasInstruments",    "텍사스인스트루먼트", 11, "2026-07-25"),
    "TTE":    ("TotalEnergies",       "토탈에너지",         11, "2026-07-25"),
    "TMUS":   ("TMobile",             "T-모바일",           12, "2026-07-25"),
    "TM":     ("Toyota",              "토요타",             10, "2026-07-25"),
    "CEG":    ("ConstellationEnergy", "컨스텔레이션에너지", 10, "2026-07-25"),
    "CCJ":    ("Cameco",              "카메코",              6, "2026-07-25"),
    "052690": ("한전기술",            "한전기술",            5, "2026-07-25"),
    "035420": ("NAVER",              "NAVER",              12, "2026-07-25"),
    "000720": ("현대건설",            "현대건설",            5, "2026-07-25"),
}
