#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-27 (10일 임계, 상한 10, staock_update 슬롯)
대상 10종: PEP v7, PG v7, MU v7, MUU v4, ORCL v6, META v8, NVO v7, GLD v7, MA v7, MRK v7
- BLIND 모드: 이전 v{N-1} 절대 read 안 함 (general-purpose 에이전트가 _content.json 작성)
- 가격은 analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 종가 2026-06-26)
- 출력: 종목당 6개 MD + scorecard + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260627_run.md (메인이 별도 작성)
"""
import json, os, sys
