#!/usr/bin/env python3
"""_content.json 스키마 정규화 — 2026-08-25 7일 회차(stock_update-2, /재분석실행 7 20→10) — 멱등.
...
PLAN = {
    "000660": "SK하이닉스_v9", "035420": "NAVER_v14", "066570": "LG전자_v11",
    "BWXT": "BWXTechnologies_v8", "CCJ": "Cameco_v8", "CEG": "ConstellationEnergy_v12",
    "DUK": "DukeEnergy_v8", "ETN": "Eaton_v12", "KTOS": "KratosDefense_v13",
    "MLSS": "MilestoneScientific_v13",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
