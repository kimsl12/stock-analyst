#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-08-01 10일 회차, /재분석실행 10 10, staock_update) — 멱등.
consensus/risks/scorecard/fragile/confidence 표준화 + 필수 키 보증 (generator KeyError 방지)."""
import json, os

PLAN = {
    "VIG":  "VanguardDividendAppreciation_v9",
    "TLT":  "iSharesTreasury_v11",
    "VRT":  "VertivHoldings_v9",
    "XOM":  "ExxonMobil_v11",
    "VST":  "VistraCorp_v9",
    "TMO":  "ThermoFisher_v4",
    "QCOM": "Qualcomm_v4",
