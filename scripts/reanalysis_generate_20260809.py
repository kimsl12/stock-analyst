"""재분석 자동 실행 — 2026-08-09 (7일 임계, 상한 10, stock_update-2 슬롯, /재분석실행 7 20→cap10)
...
PLAN = {
    "010120": ("LSELECTRIC",                 "LS일렉트릭",         13, "2026-07-31"),
    "012450": ("한화에어로스페이스",          "한화에어로스페이스", 12, "2026-07-31"),
    "034020": ("두산에너빌리티",              "두산에너빌리티",     12, "2026-07-31"),
    "035720": ("카카오",                      "카카오",             12, "2026-07-31"),
    "AGG":    ("iSharesCoreUSAggregateBond",  "아이셰어즈 미국종합채권 ETF", 11, "2026-07-31"),
    "AMAT":   ("AppliedMaterials",            "어플라이드머티어리얼즈", 13, "2026-07-31"),
    "ASTS":   ("ASTSpaceMobile",              "AST스페이스모바일",  12, "2026-07-31"),
    "AVGO":   ("Broadcom",                    "브로드컴",           13, "2026-07-31"),
    "BAC":    ("BankOfAmerica",               "뱅크오브아메리카",   12, "2026-07-31"),
    "BRKB":   ("BerkshireHathaway",           "버크셔해서웨이",     12, "2026-07-31"),
}
