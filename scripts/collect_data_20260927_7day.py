...
PLAN = {
    "GLD":  ("SPDRGoldShares",     "SPDR골드",         17, 16, "2026-09-18"),
    "HD":   ("HomeDepot",          "홈디포",           17, 16, "2026-09-18"),
    "HSBC": ("HSBC",               "HSBC홀딩스",       17, 16, "2026-09-18"),
    "IBM":  ("IBM",                "IBM",              16, 15, "2026-09-18"),
    "INTC": ("Intel",              "인텔",             17, 16, "2026-09-18"),
    "IONQ": ("IonQ",               "아이온큐",         17, 16, "2026-09-18"),
    "ISRG": ("IntuitiveSurgical",  "인튜이티브서지컬", 10,  9, "2026-09-18"),
    "JNJ":  ("JohnsonJohnson",     "존슨앤드존슨",     17, 16, "2026-09-18"),
    "LIN":  ("Linde",              "린데",             10,  9, "2026-09-18"),
    "LNG":  ("CheniereEnergy",     "셰니어에너지",     10,  9, "2026-09-18"),
}
