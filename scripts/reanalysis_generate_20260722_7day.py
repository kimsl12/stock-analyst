"""
재분석 자동 실행 — 2026-07-22 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (9일 코호트 = 2026-07-13 분석분 상위 10종):
  005380 v3, 005930 v10, 009150 v10, 207940 v3, 329180 v11, 466100 v10,
  AAPL v3, ADBE v11, AMD v3, ANET v9
- 오늘 01:00 10일 슬롯(staock_update)이 QUAL/SGOV/VEA 3종 처리 → 본 회차는 9일 코호트.
- ANTHROPIC(56일)·SPACEX(41일) 비상장·비표준 standing 제외.
- BLIND: 분석가가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격: analysis/{folder}_v{N}/data.json (fetch_price.py 수집, 종가 2026-07-21)
...
TODAY = "2026-07-22"
YYYYMMDD = "20260722"
RUN_MD = "20260722b_run"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "005380": ("현대차",             "현대차",             3,  "2026-07-13"),
    "005930": ("삼성전자",           "삼성전자",           10, "2026-07-13"),
    "009150": ("삼성전기",           "삼성전기",           10, "2026-07-13"),
    "207940": ("삼성바이오로직스",   "삼성바이오로직스",   3,  "2026-07-13"),
    "329180": ("HD현대중공업",       "HD현대중공업",       11, "2026-07-13"),
    "466100": ("클로봇",             "클로봇",             10, "2026-07-13"),
    "AAPL":   ("Apple",              "애플",               3,  "2026-07-13"),
    "ADBE":   ("Adobe",              "어도비",             11, "2026-07-13"),
    "AMD":    ("AMD",                "AMD",                3,  "2026-07-13"),
    "ANET":   ("AristaNetworks",     "아리스타네트웍스",   9,  "2026-07-13"),
}
