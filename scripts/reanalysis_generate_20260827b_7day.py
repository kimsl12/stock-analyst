#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""재분석 HTML/MD 생성 — 2026-08-27b (7일 임계, 상한 10, stock_update-2 슬롯, /재분석실행 7 20→cap10).
08-17 코호트(10일) 잔여 20종 중 티커 오름차순 상위 10종 (BABA~NVDA). 자매 10일런(01:00)이
반납한 잔여 코호트. ANTHROPIC(비상장·비표준, 92일) standing 제외.
...
PLAN = {
    "BABA": ("Alibaba",            "알리바바",             "Alibaba",                              14, "2026-08-17"),
    "BAC":  ("BankOfAmerica",      "뱅크오브아메리카",     "Bank of America",                      14, "2026-08-17"),
    "BRKB": ("BerkshireHathaway",  "버크셔해서웨이",       "Berkshire Hathaway",                   14, "2026-08-17"),
    "DIA":  ("SPDRDJIA",           "SPDR 다우존스 ETF",    "SPDR Dow Jones Industrial Average ETF",14, "2026-08-17"),
    "GEV":  ("GEVernova",          "GE버노바",             "GE Vernova",                           12, "2026-08-17"),
    "IWM":  ("iSharesRussell2000", "iShares 러셀2000 ETF", "iShares Russell 2000 ETF",             14, "2026-08-17"),
    "JPM":  ("JPMorgan",           "JP모건",               "JPMorgan Chase",                       12, "2026-08-17"),
    "KO":   ("CocaCola",           "코카콜라",             "Coca-Cola",                            13, "2026-08-17"),
    "LRCX": ("LamResearch",        "램리서치",             "Lam Research",                         12, "2026-08-17"),
    "NVDA": ("NVIDIA",             "엔비디아",             "NVIDIA",                               14, "2026-08-17"),
}

KR_TICKERS = set()  # 본 회차 전원 미국 상장 — 스케일 억제 불요
# 배당수익률 실측 유효 티커만 표기 — 게이트(0<dyp<=8)로 yfinance 스케일 아티팩트 차단
KEEP_DIV = {"KO", "BAC", "JPM", "DIA", "IWM"}
