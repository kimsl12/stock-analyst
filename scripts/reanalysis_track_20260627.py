#!/usr/bin/env python3
"""
재분석 변화 추적 — 2026-06-27 (Phase 2)
신규 v{N} _content.json vs 직전 v{N-1} scorecard.md 비교 → analysis/_reanalysis_runs/20260627_run.md
read-only 비교 (분석 영향 없음).
"""
import json, os, re

TODAY = "2026-06-27"
RUN_MD = "analysis/_reanalysis_runs/20260627_run.md"
ELAPSED = "10일"

# ticker, folder, kr, next_v, prev_v_date
PLAN = [
    ("PEP",  "PepsiCo",            "펩시코",                        7, "2026-06-17"),
    ("PG",   "PG",                 "프록터앤드갬블(P&G)",            7, "2026-06-17"),
    ("MU",   "Micron",             "마이크론",                      7, "2026-06-17"),
    ("MUU",  "DirexionDailyMU2X",  "디렉시온 마이크론 2배 레버리지 ETF", 4, "2026-06-17"),
    ("ORCL", "Oracle",             "오라클",                        6, "2026-06-17"),
    ("META", "Meta",               "메타플랫폼스",                   8, "2026-06-17"),
    ("NVO",  "NovoNordisk",        "노보노디스크",                   7, "2026-06-17"),
    ("GLD",  "SPDRGoldShares",     "SPDR 골드 셰어즈",               7, "2026-06-17"),
    ("MA",   "Mastercard",         "마스터카드",                    7, "2026-06-17"),
    ("MRK",  "Merck",              "머크",                          7, "2026-06-17"),
]
...
lines.append("")
lines.append(f"**임계 기준:** 10일 / 상한 10종 (staock_update 슬롯) | **처리:** 성공 10 / 스킵 0")
lines.append("**모드:** BLIND 재분석 (각 종목 이전 v{N-1} read 0건 — 독립 판단). 대상: 10일 경과 2026-06-17 분석분 10종.")
lines.append("> ANTHROPIC(31일, 비상장·비표준)은 standing 제외. 그 외 10일+ 경과 전 종목이 본 회차 대상.")
lines.append("")
lines.append("---")
lines.append("")
