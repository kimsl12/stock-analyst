#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-03 (회차 2, 7일 임계) — 10종 BLIND 일괄 생성
대상: INTC v4, SOXS v4, NVS v5, LUNR v4, SOXL v4, KTOS v4, TSM v4, TM v3, MS v5, MSFT v4
...
PLAN = {
    "INTC": ("Intel", "인텔", 4, "2026-05-25"),
    "SOXS": ("Direxion3xSemiBear", "Direxion 반도체 3X 인버스 ETF", 4, "2026-05-25"),
    "NVS":  ("Novartis", "노바티스", 5, "2026-05-25"),
    "LUNR": ("IntuitiveMachines", "인튜이티브 머신스", 4, "2026-05-25"),
    "SOXL": ("Direxion3xSemiconductor", "Direxion 반도체 3X ETF", 4, "2026-05-25"),
    "KTOS": ("KratosDefense", "크라토스 디펜스", 4, "2026-05-25"),
    "TSM":  ("TSMC", "TSMC", 4, "2026-05-25"),
    "TM":   ("Toyota", "도요타", 3, "2026-05-25"),
    "MS":   ("MorganStanley", "모건스탠리", 5, "2026-05-25"),
    "MSFT": ("Microsoft", "마이크로소프트", 4, "2026-05-25"),
}
