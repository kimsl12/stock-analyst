#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-08-10 7일 회차, /재분석실행 7 20→cap10, stock_update-2 슬롯) — 멱등.
consensus/risks/scorecard/fragile/confidence 표준화 + 필수 키 보증 (generator KeyError 방지)."""
import json, os

PLAN = {
    "466100": "클로봇_v12", "AMZN": "Amazon_v12", "GOOGL": "Alphabet_v12",
    "GS": "GoldmanSachs_v13", "LNG": "CheniereEnergy_v5", "MELI": "MercadoLibre_v5",
    "NFLX": "Netflix_v5", "NOW": "ServiceNow_v5", "PEP": "PepsiCo_v12", "QCOM": "Qualcomm_v5",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
