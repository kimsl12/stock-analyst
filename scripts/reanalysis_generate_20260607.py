...
PLAN = {
    "XOM": ("ExxonMobil", "엑손모빌", 5, "2026-05-26"),
    "VST": ("VistraCorp", "비스트라", 3, "2026-05-26"),
    "VRT": ("VertivHoldings", "버티브 홀딩스", 3, "2026-05-26"),
    "VIG": ("VanguardDividendAppreciation", "Vanguard 배당성장 ETF", 3, "2026-05-26"),
    "UNP": ("UnionPacific", "유니온 퍼시픽", 5, "2026-05-26"),
    "TLT": ("iSharesTreasury", "iShares 20년+ 국채 ETF", 5, "2026-05-26"),
    "TIP": ("iSharesTIPS", "iShares TIPS ETF", 5, "2026-05-26"),
    "WMT": ("Walmart", "월마트", 5, "2026-05-27"),
    "VZ":  ("Verizon", "버라이즌", 5, "2026-05-27"),
    "V":   ("Visa", "비자", 5, "2026-05-27"),
}
