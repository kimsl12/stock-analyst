#!/usr/bin/env python3
"""_content.json 스키마 정규화 (2026-08-11 7일 회차 b, /재분석실행 7 20→cap10, stock_update-2) — 멱등.
consensus/risks/scorecard/fragile/confidence 표준화 + 필수 키 보증 (generator KeyError 방지)."""
import json, os

PLAN = {
    "005380": "현대차_v5", "005930": "삼성전자_v12", "009150": "삼성전기_v12",
    "207940": "삼성바이오로직스_v5", "329180": "HD현대중공업_v13",
    "AAPL": "Apple_v5", "ABBV": "AbbVie_v11", "ADBE": "Adobe_v13",
    "AMD": "AMD_v5", "ANET": "AristaNetworks_v11",
}
SEPS = ["—", "–", "·", ":", "：", " - "]
