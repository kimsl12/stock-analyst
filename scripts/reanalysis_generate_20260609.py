#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-09 (10일 임계, 상한 10) — 10종 BLIND 일괄 생성
...
PLAN = {
    "MA":    ("Mastercard",           "마스터카드",        5, "2026-05-28"),
    "MRK":   ("Merck",                "머크",             5, "2026-05-28"),
    "NVO":   ("NovoNordisk",          "노보노디스크",      5, "2026-05-28"),
    "LLY":   ("EliLilly",             "엘리 릴리",         6, "2026-05-29"),
    "LVMUY": ("LVMH",                 "LVMH (ADR)",       6, "2026-05-29"),
    "META":  ("Meta",                 "메타 플랫폼스",      6, "2026-05-29"),
    "PLTR":  ("Palantir",             "팔란티어",          6, "2026-05-29"),
    "SNDK":  ("Sandisk",              "샌디스크",          7, "2026-05-29"),
    "SOXX":  ("iSharesSemiconductor", "iShares 반도체 ETF", 3, "2026-05-29"),
    "VOO":   ("VanguardSP500",        "뱅가드 S&P 500 ETF", 5, "2026-05-29"),
}
...
def main():
    ...
    print(f"=== 재분석 자동 실행 — {TODAY} (10일 임계) BLIND — {len(only)}종 ===\n")
    ok, fail = [], []
    for ticker in only:
