#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""재분석 HTML/MD 생성 — 2026-08-26 (10일 임계, 상한 10, staock_update 슬롯, /재분석실행 10 10).
08-16 코호트(10일) 중 알파벳 정렬 상위 10종 (ANTHROPIC 비상장 standing 제외).
7일런(cap 10/일)이 146종 유니버스를 10일 내 다 못 덮어 새어나온 오버플로 코호트.
- BLIND: 분석가(Agent 10종 병렬)가 _content.json 작성 (이전 v·HTML·timeline 미참조)
- 가격/펀더멘털: analysis/{folder}_v{N}/data.json (collect_data_20260826_10day.py, yfinance 리치 수집)
...
PLAN = {
    "000720": ("현대건설",                       "현대건설",         "Hyundai E&C",                        7,  "2026-08-16"),
    "052690": ("한전기술",                       "한전기술",         "KEPCO E&C",                          7,  "2026-08-16"),
    "JEPI":   ("JPMorganEquityPremiumIncome",   "JEPI",            "JPMorgan Equity Premium Income ETF", 7,  "2026-08-16"),
    "LQD":    ("iSharesInvestmentGradeCorpBond","LQD",             "iShares iBoxx $ IG Corp Bond ETF",   7,  "2026-08-16"),
    "MLM":    ("MartinMarietta",                "마틴마리에타",     "Martin Marietta",                    8,  "2026-08-16"),
    "MUFG":   ("Mitsubishi",                    "미쓰비시UFJ",      "Mitsubishi UFJ",                     14, "2026-08-16"),
    "NEE":    ("NextEraEnergy",                 "넥스트에라에너지", "NextEra Energy",                     8,  "2026-08-16"),
    "NKE":    ("Nike",                          "나이키",           "Nike",                               13, "2026-08-16"),
    "O":      ("RealtyIncome",                  "리얼티인컴",       "Realty Income",                      7,  "2026-08-16"),
    "OKLO":   ("Oklo",                          "오클로",           "Oklo",                               7,  "2026-08-16"),
}

KR_TICKERS = {"000720", "052690"}
# 배당수익률 실측 유효 티커만 표기 — 게이트(0<dyp<=8)로 yfinance 스케일 아티팩트 차단
KEEP_DIV = {"NEE", "O", "MUFG", "MLM", "NKE", "JEPI", "LQD"}
