"""재분석 자동 실행 — 2026-08-10 (10일 임계, 상한 10, staock_update 슬롯, /재분석실행 10 10)
...
PLAN = {
    "WMT":  ("Walmart",       "월마트",       12, "2026-07-31"),
    "V":    ("Visa",          "비자",         12, "2026-07-31"),
    "VZ":   ("Verizon",       "버라이즌",     12, "2026-07-31"),
    "TSLA": ("Tesla",         "테슬라",       12, "2026-07-31"),
    "TIP":  ("iSharesTIPS",   "아이셰어즈 물가연동국채 ETF", 12, "2026-07-31"),
    "STX":  ("Seagate",       "시게이트",     12, "2026-07-31"),
    "SMR":  ("NuScalePower",  "뉴스케일파워", 10, "2026-07-31"),
    "DIS":  ("Disney",        "디즈니",       12, "2026-07-31"),
    "C":    ("Citigroup",     "씨티그룹",     12, "2026-07-31"),
    "CAT":  ("Caterpillar",   "캐터필러",     12, "2026-07-31"),
}
