#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-06-17 (7일 임계, 상한 20→10 클램핑) — 10종 BLIND 일괄 생성
대상: 010120 v7, 012450 v6, 034020 v6, 035720 v6, ABBV v5, AGG v5, AMAT v7, AMZN v6, ASTS v6, AVGO v7
- BLIND 모드: 이전 v{N-1} 절대 read 안 함 (specialist 에이전트가 _content.json 작성)
- 가격은 analysis/{folder}_v{N}/data.json (사전 fetch_price.py 수집, 기준일 2026-06-16)
- 출력: 종목당 6개 MD + HTML 리포트
- 회차 보고: analysis/_reanalysis_runs/20260617_run.md
"""
import json, os, sys
...
PLAN = {
    "010120": ("LSELECTRIC",                 "LS일렉트릭",             7, "2026-06-08"),
    "012450": ("한화에어로스페이스",         "한화에어로스페이스",     6, "2026-06-08"),
    "034020": ("두산에너빌리티",             "두산에너빌리티",         6, "2026-06-08"),
    "035720": ("카카오",                     "카카오",                 6, "2026-06-08"),
    "ABBV":   ("AbbVie",                     "애브비",                 5, "2026-06-08"),
    "AGG":    ("iSharesCoreUSAggregateBond", "iShares 미국종합채권 ETF", 5, "2026-06-08"),
    "AMAT":   ("AppliedMaterials",           "어플라이드 머티어리얼즈", 7, "2026-06-08"),
    "AMZN":   ("Amazon",                     "아마존",                 6, "2026-06-08"),
    "ASTS":   ("ASTSpaceMobile",             "AST 스페이스모바일",     6, "2026-06-08"),
    "AVGO":   ("Broadcom",                   "브로드컴",               7, "2026-06-08"),
}
        ...
        "custom_sections": [
            ...
            },
            {
                ...
                "content": (
                    ...
                    f"- **임계 경과**: 9일 (7일 임계, 상한 20→10종 클램핑, 2026-06-17)\n"
