#!/usr/bin/env python3
"""
재분석 자동 실행 — 2026-07-04 (7일 임계, 상한 20→10 클램핑, stock_update-2 슬롯)
대상 10종 (8~9일 stale, 06-25/26 배치):
...
- 회차 보고: analysis/_reanalysis_runs/20260704_run_7day.md (메인이 별도 작성)
...
TODAY = "2026-07-04"
YYYYMMDD = "20260704"
RUN_MD = "20260704_run_7day"
THRESHOLD = 7

# ticker -> (folder_name, name_kr, next_v, prev_v_date)
PLAN = {
    "USMV":  ("iSharesMinVol",   "iShares 미국 최소변동성 ETF", 8, "2026-06-25"),
    "BA":    ("Boeing",          "보잉",                        8, "2026-06-26"),
    "BLK":   ("BlackRock",       "블랙록",                      8, "2026-06-26"),
    "GE":    ("GEAerospace",     "GE에어로스페이스",            8, "2026-06-26"),
    "GLD":   ("SPDRGoldShares",  "SPDR 골드셰어즈 ETF",         8, "2026-06-26"),
    "GOOGL": ("Alphabet",        "알파벳",                      8, "2026-06-26"),
    "GS":    ("GoldmanSachs",    "골드만삭스",                  9, "2026-06-26"),
    "HD":    ("HomeDepot",       "홈디포",                      8, "2026-06-26"),
    "HSBC":  ("HSBC",            "HSBC",                        8, "2026-06-26"),
    "JNJ":   ("JohnsonJohnson",  "존슨앤드존슨",                8, "2026-06-26"),
}
