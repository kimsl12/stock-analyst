...
with open(os.path.join(_root, 'ktos_report_data.json'), encoding='utf-8') as f:
    data = json.load(f)
...
# risks must remain dict (not tuple)

output_path = os.path.join(_root, 'reports', 'KTOS_KratosDefense_20260416.html')
